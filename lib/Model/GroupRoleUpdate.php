...
/**
 * GroupRoleUpdate Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GroupRoleUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GroupRoleUpdate';
    ...
    */
     ...
     *
     * @param bool|null $counts_towards_seats counts_towards_seats
     *
     * @return self
     */
    ...
    public function setHtmlTemplateIds($html_template_ids)
    {
        if (is_null($html_template_ids)) {
            throw new \InvalidArgumentException('non-nullable html_template_ids cannot be null');
        }
