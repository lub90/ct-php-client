...
class PersonRelationship implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'relative' => '\ChurchTools\Model\GetBookings200ResponseDataInnerBookingBaseInvolvedPersonsDomainObjectsCreatedBy'
    ];
    ...
    */
     ...
     * Sets id
     *
     * @param int $id ID of the relationship
     *
     * @return self
     */
     ...
     * Sets relative
     *
     * @param \ChurchTools\Model\GetBookings200ResponseDataInnerBookingBaseInvolvedPersonsDomainObjectsCreatedBy $relative relative
     *
     * @return self
     */
    ...
    {
        if (is_null($relative)) {
            array_push($this->openAPINullablesSetToNull, 'relative');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('relative', $nullablesSetToNull);
            if ($index !== FALSE) {
