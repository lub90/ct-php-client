...
/**
 * GetPersonsBirthdays200ResponseDataInnerPerson Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GetPersonsBirthdays200ResponseDataInnerPerson implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_persons_birthdays_200_response_data_inner_person';
    ...
    protected static $openAPITypes = [
        'api_url' => 'string',
        'domain_attributes' => '\ChurchTools\Model\GetPersonsBirthdays200ResponseDataInnerPersonDomainAttributes',
    ...
    */
     ...
     *
     * @return \ChurchTools\Model\GetPersonsBirthdays200ResponseDataInnerPersonDomainAttributes
     */
     ...
     *
     * @param \ChurchTools\Model\GetPersonsBirthdays200ResponseDataInnerPersonDomainAttributes $domain_attributes domain_attributes
     *
     * @return self
     */
    ...
    public function setDomainIdentifier($domain_identifier)
    {
        ...
        if ((mb_strlen($domain_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $domain_identifier when calling GetPersonsBirthdays200ResponseDataInnerPerson., must be bigger than or equal to 1.');
        }
    ...
    public function setFrontendUrl($frontend_url)
    {
        ...
        if ((mb_strlen($frontend_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $frontend_url when calling GetPersonsBirthdays200ResponseDataInnerPerson., must be bigger than or equal to 1.');
        }
