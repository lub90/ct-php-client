...
/**
 * StatementMovement Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class StatementMovement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StatementMovement';
    ...
    protected static $openAPITypes = [
        ...
        'purpose' => 'string',
        'state' => 'string',
        'suggestions' => '\ChurchTools\Model\StatementMovementSuggestionsInner[]',
    ...
    */
    ...
    public function setNumberInStatement($number_in_statement)
    {
        if (is_null($number_in_statement)) {
            throw new \InvalidArgumentException('non-nullable number_in_statement cannot be null');
        }
     ...
     * Gets suggestions
     *
     * @return \ChurchTools\Model\StatementMovementSuggestionsInner[]
     */
     ...
     * Sets suggestions
     *
     * @param \ChurchTools\Model\StatementMovementSuggestionsInner[] $suggestions suggestions
     *
     * @return self
     */
