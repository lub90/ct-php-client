...
class SendEventEmailRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('append_agenda_button', $data ?? [], null);
        $this->setIfExists('body', $data ?? [], null);
        $this->setIfExists('event_ids', $data ?? [], null);
        $this->setIfExists('files', $data ?? [], null);
        $this->setIfExists('recipients', $data ?? [], null);
        $this->setIfExists('send_copy_to_me', $data ?? [], false);
    ...
    */
    ...
    {
        if (is_null($append_agenda_button)) {
            throw new \InvalidArgumentException('non-nullable append_agenda_button cannot be null');
        }
    ...
    {
        if (is_null($send_copy_to_me)) {
            throw new \InvalidArgumentException('non-nullable send_copy_to_me cannot be null');
        }
