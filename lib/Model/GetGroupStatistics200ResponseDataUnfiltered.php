<?php
/**
 * GetGroupStatistics200ResponseDataUnfiltered
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * GetGroupStatistics200ResponseDataUnfiltered Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GetGroupStatistics200ResponseDataUnfiltered implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_group_statistics_200_response_data_unfiltered';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['all_places'] === null) {
            $invalidProperties[] = "'all_places' can't be null";
        }
        if ($this->container['free_places'] === null) {
            $invalidProperties[] = "'free_places' can't be null";
        }
        if ($this->container['requested_places'] === null) {
            $invalidProperties[] = "'requested_places' can't be null";
        }
        if ($this->container['taken_places'] === null) {
            $invalidProperties[] = "'taken_places' can't be null";
        }
        if ($this->container['waitinglist_places'] === null) {
            $invalidProperties[] = "'waitinglist_places' can't be null";
        }
     ...
     * Sets all_places
     *
     * @param int $all_places Count of all members (excluding hidden roles and to delete)
     *
     * @return self
     */
     ...
     * Sets free_places
     *
     * @param int $free_places Count of free places in group
     *
     * @return self
     */
     ...
     *
     * @param int $requested_places Count of requested places
     *
     * @return self
     */
     ...
     * Sets taken_places
     *
     * @param int $taken_places Count of taken places in group
     *
     * @return self
     */
     ...
     *
     * @param int $waitinglist_places Count of people on waiting list
     *
     * @return self
     */
