...
/**
 * ProfileUpdateServicesInner Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class ProfileUpdateServicesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProfileUpdate_services_inner';
    ...
    */
    ...
    public function setNote($note)
    {
        ...
        if ((mb_strlen($note) < 1)) {
            throw new \InvalidArgumentException('invalid length for $note when calling ProfileUpdateServicesInner., must be bigger than or equal to 1.');
        }
    ...
    public function setRepetition($repetition)
    {
        ...
        if ((mb_strlen($repetition) < 1)) {
            throw new \InvalidArgumentException('invalid length for $repetition when calling ProfileUpdateServicesInner., must be bigger than or equal to 1.');
        }
    ...
    public function setTime($time)
    {
        ...
        if ((mb_strlen($time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $time when calling ProfileUpdateServicesInner., must be bigger than or equal to 1.');
        }
