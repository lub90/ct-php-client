...
class ReportCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'domain_id' => 'int',
        'domain_type' => 'string',
        'reporter' => '\ChurchTools\Model\ReportCreateReporter'
    ];
    ...
    */
    ...
    public function setComment($comment)
    {
        ...
        if ((mb_strlen($comment) > 500)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling ReportCreate., must be smaller than or equal to 500.');
        }
     ...
     * Gets reporter
     *
     * @return \ChurchTools\Model\ReportCreateReporter|null
     */
     ...
     * Sets reporter
     *
     * @param \ChurchTools\Model\ReportCreateReporter|null $reporter reporter
     *
     * @return self
     */
