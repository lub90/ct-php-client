<?php
/**
 * UpdateCampusRequestSignUpGroup
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * UpdateCampusRequestSignUpGroup Class Doc Comment
 *
 * @category Class
 * @description SignUp Group; Either groupId or domainObject
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateCampusRequestSignUpGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_campus_request_signUpGroup';
    ...
    protected static $openAPITypes = [
        'domain_attributes' => '\ChurchTools\Model\UpdateCampusRequestSignUpGroupDomainAttributes',
    ...
    */
     ...
     *
     * @return \ChurchTools\Model\UpdateCampusRequestSignUpGroupDomainAttributes
     */
     ...
     *
     * @param \ChurchTools\Model\UpdateCampusRequestSignUpGroupDomainAttributes $domain_attributes domain_attributes
     *
     * @return self
     */
    ...
    public function setDomainIdentifier($domain_identifier)
    {
        ...
        if ((mb_strlen($domain_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $domain_identifier when calling UpdateCampusRequestSignUpGroup., must be bigger than or equal to 1.');
        }
