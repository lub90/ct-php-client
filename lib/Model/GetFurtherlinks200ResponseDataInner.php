<?php
/**
 * GetFurtherlinks200ResponseDataInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * GetFurtherlinks200ResponseDataInner Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GetFurtherlinks200ResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_furtherlinks_200_response_data_inner';
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 400)) {
            throw new \InvalidArgumentException('invalid length for $description when calling GetFurtherlinks200ResponseDataInner., must be smaller than or equal to 400.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling GetFurtherlinks200ResponseDataInner., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($name) < 2)) {
            throw new \InvalidArgumentException('invalid length for $name when calling GetFurtherlinks200ResponseDataInner., must be bigger than or equal to 2.');
        }
