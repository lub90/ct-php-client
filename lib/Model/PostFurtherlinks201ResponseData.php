...
/**
 * PostFurtherlinks201ResponseData Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class PostFurtherlinks201ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_furtherlinks_201_response_data';
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 400)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PostFurtherlinks201ResponseData., must be smaller than or equal to 400.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PostFurtherlinks201ResponseData., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($name) < 2)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PostFurtherlinks201ResponseData., must be bigger than or equal to 2.');
        }
