...
/**
 * PutPersonsAbsenceRequest Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class PutPersonsAbsenceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'put_persons_absence_request';
    ...
    {
        $this->setIfExists('absence_reason_id', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($absence_reason_id)) {
            array_push($this->openAPINullablesSetToNull, 'absence_reason_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('absence_reason_id', $nullablesSetToNull);
            if ($index !== FALSE) {
