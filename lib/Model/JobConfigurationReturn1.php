...
class JobConfigurationReturn1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'domain_type' => 'string',
        'external_system' => '\ChurchTools\Model\ExternalSystem4',
        'id' => 'int',
    ...
    protected static array $openAPINullables = [
        ...
        'create_behavior_es' => true,
        'create_behavior_master' => true,
        'create_defaults_es' => false,
        'create_defaults_master' => false,
        'delete_behavior_es' => true,
        'delete_behavior_master' => true,
        'domain_type' => true,
    ...
    */
    ...
    public function setCreateBehaviorEs($create_behavior_es)
    {
        if (is_null($create_behavior_es)) {
            array_push($this->openAPINullablesSetToNull, 'create_behavior_es');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('create_behavior_es', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    public function setCreateBehaviorMaster($create_behavior_master)
    {
        if (is_null($create_behavior_master)) {
            array_push($this->openAPINullablesSetToNull, 'create_behavior_master');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('create_behavior_master', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setDeleteBehaviorEs($delete_behavior_es)
    {
        if (is_null($delete_behavior_es)) {
            array_push($this->openAPINullablesSetToNull, 'delete_behavior_es');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('delete_behavior_es', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setDeleteBehaviorMaster($delete_behavior_master)
    {
        if (is_null($delete_behavior_master)) {
            array_push($this->openAPINullablesSetToNull, 'delete_behavior_master');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('delete_behavior_master', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @return \ChurchTools\Model\ExternalSystem4|null
     */
     ...
     *
     * @param \ChurchTools\Model\ExternalSystem4|null $external_system external_system
     *
     * @return self
     */
    ...
    public function setLinkData($link_data)
    {
        if (is_null($link_data)) {
            array_push($this->openAPINullablesSetToNull, 'link_data');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('link_data', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setUpdateBehavior($update_behavior)
    {
        if (is_null($update_behavior)) {
            array_push($this->openAPINullablesSetToNull, 'update_behavior');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('update_behavior', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setUpdateData($update_data)
    {
        if (is_null($update_data)) {
            array_push($this->openAPINullablesSetToNull, 'update_data');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('update_data', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
