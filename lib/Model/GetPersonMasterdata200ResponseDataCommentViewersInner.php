<?php
/**
 * GetPersonMasterdata200ResponseDataCommentViewersInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * GetPersonMasterdata200ResponseDataCommentViewersInner Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GetPersonMasterdata200ResponseDataCommentViewersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getPersonMasterdata_200_response_data_commentViewers_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id ID of comment viewer group
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Name of comment viewer group
     *
     * @return self
     */
     ...
     *
     * @param string $name_translated Translated name of comment viewer group
     *
     * @return self
     */
