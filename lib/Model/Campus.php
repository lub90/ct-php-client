 ...
 */
class Campus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Campus';
    ...
    */
    ...
    public function setShortName($short_name)
    {
        ...
        if ((mb_strlen($short_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $short_name when calling Campus., must be bigger than or equal to 0.');
        }
