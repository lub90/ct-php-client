 ...
 */
class ExternalSystem2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExternalSystem_2';
    ...
    {
        $this->setIfExists('access_header_values', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($access_header_values)) {
            throw new \InvalidArgumentException('non-nullable access_header_values cannot be null');
        }
