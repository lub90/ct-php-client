...
/**
 * GetApiProfiles200ResponseDataInnerGroupsInner Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GetApiProfiles200ResponseDataInnerGroupsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_api_profiles_200_response_data_inner_groups_inner';
    ...
    */
    ...
    public function setGroupHomepageApi($group_homepage_api)
    {
        if (is_null($group_homepage_api)) {
            array_push($this->openAPINullablesSetToNull, 'group_homepage_api');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('group_homepage_api', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        if (!is_null($group_homepage_api) && (mb_strlen($group_homepage_api) < 1)) {
            throw new \InvalidArgumentException('invalid length for $group_homepage_api when calling GetApiProfiles200ResponseDataInnerGroupsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setGroupHomepageUrl($group_homepage_url)
    {
        ...
        if (!is_null($group_homepage_url) && (mb_strlen($group_homepage_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $group_homepage_url when calling GetApiProfiles200ResponseDataInnerGroupsInner., must be bigger than or equal to 1.');
        }
