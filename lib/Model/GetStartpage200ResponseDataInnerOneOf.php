...
/**
 * GetStartpage200ResponseDataInnerOneOf Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GetStartpage200ResponseDataInnerOneOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_startpage_200_response_data_inner_oneOf';
    ...
    protected static $openAPITypes = [
        'actions' => '\ChurchTools\Model\WidgetAction1[]',
        ...
        'items' => '\ChurchTools\Model\GetStartpage200ResponseDataInnerOneOfAllOfItemsInner[]',
        'widget_type' => 'string'
    ];
    ...
    public const WIDGET_TYPE_DATE = 'date';
    ...
    */
     ...
     * Gets actions
     *
     * @return \ChurchTools\Model\WidgetAction1[]|null
     */
     ...
     * Sets actions
     *
     * @param \ChurchTools\Model\WidgetAction1[]|null $actions actions
     *
     * @return self
     */
    ...
    public function setReplacement($replacement)
    {
        if (is_null($replacement)) {
            array_push($this->openAPINullablesSetToNull, 'replacement');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('replacement', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets items
     *
     * @return \ChurchTools\Model\GetStartpage200ResponseDataInnerOneOfAllOfItemsInner[]
     */
     ...
     * Sets items
     *
     * @param \ChurchTools\Model\GetStartpage200ResponseDataInnerOneOfAllOfItemsInner[] $items items
     *
     * @return self
     */
