    ...
    */
    ...
    public function setAddition($addition)
    {
        ...
        if (!is_null($addition) && (mb_strlen($addition) > 100)) {
            throw new \InvalidArgumentException('invalid length for $addition when calling Address., must be smaller than or equal to 100.');
        }
    ...
    public function setDistrict($district)
    {
        ...
        if (!is_null($district) && (mb_strlen($district) > 100)) {
            throw new \InvalidArgumentException('invalid length for $district when calling Address., must be smaller than or equal to 100.');
        }
    ...
    public function setIcon($icon)
    {
        ...
        if (!is_null($icon) && (mb_strlen($icon) > 40)) {
            throw new \InvalidArgumentException('invalid length for $icon when calling Address., must be smaller than or equal to 40.');
        }
    ...
    public function setStreet($street)
    {
        ...
        if (!is_null($street) && (mb_strlen($street) > 100)) {
            throw new \InvalidArgumentException('invalid length for $street when calling Address., must be smaller than or equal to 100.');
        }
    ...
    public function setZip($zip)
    {
        ...
        if (!is_null($zip) && (mb_strlen($zip) > 100)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling Address., must be smaller than or equal to 100.');
        }
