...
/**
 * CreateNewStatusRequest Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class CreateNewStatusRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createNewStatus_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_searchable', $data ?? [], true);
        $this->setIfExists('name', $data ?? [], null);
        $this->setIfExists('security_level_id', $data ?? [], 1);
        $this->setIfExists('shorty', $data ?? [], null);
        $this->setIfExists('sort_key', $data ?? [], 10);
    }
    ...
    */
     ...
     * Sets is_searchable
     *
     * @param bool|null $is_searchable is_searchable
     *
     * @return self
     */
