...
class GetGroups200ResponseDataInnerFollowUp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'target_group_member_status_id' => true,
        'target_object_id' => true,
        'target_type_id' => false,
        'type_id' => true
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('target_group_member_status_id', $data ?? [], null);
        $this->setIfExists('target_object_id', $data ?? [], null);
        $this->setIfExists('target_type_id', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($target_group_member_status_id)) {
            array_push($this->openAPINullablesSetToNull, 'target_group_member_status_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('target_group_member_status_id', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    {
        if (is_null($target_object_id)) {
            array_push($this->openAPINullablesSetToNull, 'target_object_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('target_object_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($target_type_id)) {
            throw new \InvalidArgumentException('non-nullable target_type_id cannot be null');
        }
