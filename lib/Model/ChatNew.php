 ...
 */
class ChatNew implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChatNew';
    ...
    */
    ...
    {
        if (is_null($roomname)) {
            throw new \InvalidArgumentException('non-nullable roomname cannot be null');
        }
