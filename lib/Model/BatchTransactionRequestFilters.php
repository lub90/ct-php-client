...
class BatchTransactionRequestFilters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('include_ids', $data ?? [], null);
        $this->setIfExists('exclude', $data ?? [], null);
        $this->setIfExists('exclude_ids', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['include_ids'] === null) {
            $invalidProperties[] = "'include_ids' can't be null";
        }
        if ($this->container['exclude_ids'] === null) {
            $invalidProperties[] = "'exclude_ids' can't be null";
        }
     ...
     * Sets include
     *
     * @param int[]|null $include List of Transaction IDs. Only those Transactions are updated.
     *
     * @return self
     */
    ...
    {
        return $this->container['include_ids'];
    }

    /**
     * Sets include_ids
     *
     * @param int[] $include_ids List of Transaction IDs. Only those Transactions are updated.
     *
     * @return self
     */
    public function setIncludeIds($include_ids)
    {
        if (is_null($include_ids)) {
            throw new \InvalidArgumentException('non-nullable include_ids cannot be null');
        }
        $this->container['include_ids'] = $include_ids;
     ...
     * Sets exclude
     *
     * @param int[]|null $exclude List of Transaction IDs. All Transactions except this list of IDs are updated in the given Accouting Period.
     *
     * @return self
     */
     ...
     * Sets exclude_ids
     *
     * @param int[] $exclude_ids List of Transaction IDs. All Transactions except this list of IDs are updated in the given Accouting Period.
     *
     * @return self
     */
    public function setExcludeIds($exclude_ids)
    {
        if (is_null($exclude_ids)) {
            throw new \InvalidArgumentException('non-nullable exclude_ids cannot be null');
        }
