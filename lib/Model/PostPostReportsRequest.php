...
/**
 * PostPostReportsRequest Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class PostPostReportsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_post_reports_request';
    ...
    protected static $openAPITypes = [
        ...
        'domain_id' => 'int',
        'domain_type' => 'string',
        'reporter' => '\ChurchTools\Model\PostPostReportsRequestReporter'
    ];
    ...
    */
    ...
    public function setComment($comment)
    {
        ...
        if ((mb_strlen($comment) > 500)) {
            throw new \InvalidArgumentException('invalid length for $comment when calling PostPostReportsRequest., must be smaller than or equal to 500.');
        }
     ...
     * Gets reporter
     *
     * @return \ChurchTools\Model\PostPostReportsRequestReporter|null
     */
     ...
     * Sets reporter
     *
     * @param \ChurchTools\Model\PostPostReportsRequestReporter|null $reporter reporter
     *
     * @return self
     */
