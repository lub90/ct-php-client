...
/**
 * GetGroupsGroupIdMembersRoutines200ResponseDataInnerRoutine Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GetGroupsGroupIdMembersRoutines200ResponseDataInnerRoutine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_groups_groupId_members_routines_200_response_data_inner_routine';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'priority' => 'int',
        'steps' => '\ChurchTools\Model\GetGroupsGroupIdMembersRoutines200ResponseDataInnerRoutineStepsInner[]'
    ];
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling GetGroupsGroupIdMembersRoutines200ResponseDataInnerRoutine., must be smaller than or equal to 1000.');
        }
     ...
     * Gets steps
     *
     * @return \ChurchTools\Model\GetGroupsGroupIdMembersRoutines200ResponseDataInnerRoutineStepsInner[]
     */
     ...
     * Sets steps
     *
     * @param \ChurchTools\Model\GetGroupsGroupIdMembersRoutines200ResponseDataInnerRoutineStepsInner[] $steps steps
     *
     * @return self
     */
