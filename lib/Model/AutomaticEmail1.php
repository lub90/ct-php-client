...
/**
 * AutomaticEmail1 Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  ChurchTools
 ...
 */
class AutomaticEmail1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Automatic_Email_1';
    ...
    protected static $openAPITypes = [
        ...
        'role_id' => 'int',
        'sender' => '\ChurchTools\Model\PostBookings201ResponseDataInvolvedPersonsDomainObjectsCreatedBy',
        'subject' => 'string'
    ];
    ...
    */
    ...
    public function setBody($body)
    {
        ...
        if ((mb_strlen($body) < 1)) {
            throw new \InvalidArgumentException('invalid length for $body when calling AutomaticEmail1., must be bigger than or equal to 1.');
        }
     ...
     * Sets sender
     *
     * @param \ChurchTools\Model\PostBookings201ResponseDataInvolvedPersonsDomainObjectsCreatedBy $sender sender
     *
     * @return self
     */
    ...
    public function setSubject($subject)
    {
        ...
        if ((mb_strlen($subject) < 1)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling AutomaticEmail1., must be bigger than or equal to 1.');
        }
