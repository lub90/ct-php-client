...
class GetAllData200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'account_classes' => '\ChurchTools\Model\GetAllAccountClasses200ResponseDataInner[]',
        'account_groups' => '\ChurchTools\Model\GetAllAccountGroups200ResponseDataInner[]',
        'account_types' => '\ChurchTools\Model\GetAllAccountTypes200ResponseDataInner[]',
        'accounting_periods' => '\ChurchTools\Model\CreateNewAccountingPeriod201ResponseData[]',
        'accounts' => '\ChurchTools\Model\GetAllAccounts200ResponseDataInner[]',
        'cash_discounts' => '\ChurchTools\Model\GetAllCashDiscounts200ResponseDataInner[]',
        'clients' => '\ChurchTools\Model\GetAllClients200ResponseDataInner[]',
        'cost_centers' => '\ChurchTools\Model\CostCenter[]',
        'tax_rates' => '\ChurchTools\Model\GetAllData200ResponseDataTaxRatesInner[]',
        'tax_types' => '\ChurchTools\Model\GetAllData200ResponseDataTaxTypesInner[]',
        'transaction_purposes' => '\ChurchTools\Model\GetAllData200ResponseDataTransactionPurposesInner[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['account_classes'] === null) {
            $invalidProperties[] = "'account_classes' can't be null";
        }
        if ($this->container['account_groups'] === null) {
            $invalidProperties[] = "'account_groups' can't be null";
        }
        if ($this->container['account_types'] === null) {
            $invalidProperties[] = "'account_types' can't be null";
        }
        if ($this->container['accounting_periods'] === null) {
            $invalidProperties[] = "'accounting_periods' can't be null";
        }
        if ($this->container['accounts'] === null) {
            $invalidProperties[] = "'accounts' can't be null";
        }
        if ($this->container['cash_discounts'] === null) {
            $invalidProperties[] = "'cash_discounts' can't be null";
        }
        if ($this->container['clients'] === null) {
            $invalidProperties[] = "'clients' can't be null";
        }
        if ($this->container['cost_centers'] === null) {
            $invalidProperties[] = "'cost_centers' can't be null";
        }
        if ($this->container['tax_rates'] === null) {
            $invalidProperties[] = "'tax_rates' can't be null";
        }
        if ($this->container['tax_types'] === null) {
            $invalidProperties[] = "'tax_types' can't be null";
        }
        if ($this->container['transaction_purposes'] === null) {
            $invalidProperties[] = "'transaction_purposes' can't be null";
        }
     ...
     *
     * @return \ChurchTools\Model\GetAllAccountClasses200ResponseDataInner[]
     */
     ...
     *
     * @param \ChurchTools\Model\GetAllAccountClasses200ResponseDataInner[] $account_classes account_classes
     *
     * @return self
     */
     ...
     * Gets account_groups
     *
     * @return \ChurchTools\Model\GetAllAccountGroups200ResponseDataInner[]
     */
     ...
     * Sets account_groups
     *
     * @param \ChurchTools\Model\GetAllAccountGroups200ResponseDataInner[] $account_groups account_groups
     *
     * @return self
     */
     ...
     * Gets account_types
     *
     * @return \ChurchTools\Model\GetAllAccountTypes200ResponseDataInner[]
     */
     ...
     * Sets account_types
     *
     * @param \ChurchTools\Model\GetAllAccountTypes200ResponseDataInner[] $account_types account_types
     *
     * @return self
     */
     ...
     *
     * @return \ChurchTools\Model\CreateNewAccountingPeriod201ResponseData[]
     */
     ...
     *
     * @param \ChurchTools\Model\CreateNewAccountingPeriod201ResponseData[] $accounting_periods accounting_periods
     *
     * @return self
     */
     ...
     * Gets accounts
     *
     * @return \ChurchTools\Model\GetAllAccounts200ResponseDataInner[]
     */
     ...
     * Sets accounts
     *
     * @param \ChurchTools\Model\GetAllAccounts200ResponseDataInner[] $accounts accounts
     *
     * @return self
     */
     ...
     * Gets cash_discounts
     *
     * @return \ChurchTools\Model\GetAllCashDiscounts200ResponseDataInner[]
     */
     ...
     * Sets cash_discounts
     *
     * @param \ChurchTools\Model\GetAllCashDiscounts200ResponseDataInner[] $cash_discounts cash_discounts
     *
     * @return self
     */
     ...
     * Gets clients
     *
     * @return \ChurchTools\Model\GetAllClients200ResponseDataInner[]
     */
     ...
     * Sets clients
     *
     * @param \ChurchTools\Model\GetAllClients200ResponseDataInner[] $clients clients
     *
     * @return self
     */
     ...
     * Gets cost_centers
     *
     * @return \ChurchTools\Model\CostCenter[]
     */
     ...
     * Sets cost_centers
     *
     * @param \ChurchTools\Model\CostCenter[] $cost_centers cost_centers
     *
     * @return self
     */
     ...
     * Gets tax_rates
     *
     * @return \ChurchTools\Model\GetAllData200ResponseDataTaxRatesInner[]
     */
     ...
     * Sets tax_rates
     *
     * @param \ChurchTools\Model\GetAllData200ResponseDataTaxRatesInner[] $tax_rates tax_rates
     *
     * @return self
     */
     ...
     * Gets tax_types
     *
     * @return \ChurchTools\Model\GetAllData200ResponseDataTaxTypesInner[]
     */
     ...
     * Sets tax_types
     *
     * @param \ChurchTools\Model\GetAllData200ResponseDataTaxTypesInner[] $tax_types tax_types
     *
     * @return self
     */
     ...
     *
     * @return \ChurchTools\Model\GetAllData200ResponseDataTransactionPurposesInner[]
     */
     ...
     *
     * @param \ChurchTools\Model\GetAllData200ResponseDataTransactionPurposesInner[] $transaction_purposes transaction_purposes
     *
     * @return self
     */
