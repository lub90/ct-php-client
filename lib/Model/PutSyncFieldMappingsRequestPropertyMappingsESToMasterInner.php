...
/**
 * PutSyncFieldMappingsRequestPropertyMappingsESToMasterInner Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class PutSyncFieldMappingsRequestPropertyMappingsESToMasterInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'put_sync_field_mappings_request_propertyMappingsESToMaster_inner';
    ...
    */
    ...
    public function setFromFilter($from_filter)
    {
        if (is_null($from_filter)) {
            array_push($this->openAPINullablesSetToNull, 'from_filter');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('from_filter', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setToFilter($to_filter)
    {
        if (is_null($to_filter)) {
            array_push($this->openAPINullablesSetToNull, 'to_filter');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('to_filter', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
