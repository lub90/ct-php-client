...
/**
 * GetAllData200ResponseDataTransactionPurposesInner Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GetAllData200ResponseDataTransactionPurposesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getAllData_200_response_data_transactionPurposes_inner';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('purpose_account_id', $data ?? [], null);
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling GetAllData200ResponseDataTransactionPurposesInner., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 2)) {
            throw new \InvalidArgumentException('invalid length for $name when calling GetAllData200ResponseDataTransactionPurposesInner., must be bigger than or equal to 2.');
        }
    ...
    {
        if (is_null($purpose_account_id)) {
            throw new \InvalidArgumentException('non-nullable purpose_account_id cannot be null');
        }
