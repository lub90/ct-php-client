...
class GetPublicGroupSignoutData200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'leader_sign_out_persons' => '\ChurchTools\Model\GetBookings200ResponseDataInnerBookingBaseInvolvedPersonsDomainObjectsCreatedBy[]',
        'no_user_created' => 'bool',
        'requester' => '\ChurchTools\Model\GetPublicGroupSignoutData200ResponseDataRequester',
        'requester_email' => 'string',
        'self_sign_out_persons' => '\ChurchTools\Model\PostBookings201ResponseDataInvolvedPersonsDomainObjectsCreatedBy[]',
        'token' => 'string'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'leader_sign_out_persons' => true,
        'no_user_created' => false,
        'requester' => false,
        'requester_email' => true,
        'self_sign_out_persons' => true,
        'token' => true
    ];
    ...
    protected static $setters = [
        ...
        'no_user_created' => 'setNoUserCreated',
    ...
    protected static $getters = [
        ...
        'no_user_created' => 'getNoUserCreated',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('no_user_created', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['group_has_auto_accept'] === null) {
            $invalidProperties[] = "'group_has_auto_accept' can't be null";
        }
        if ($this->container['leader_sign_out_persons'] === null) {
            $invalidProperties[] = "'leader_sign_out_persons' can't be null";
        }
        if ($this->container['requester'] === null) {
            $invalidProperties[] = "'requester' can't be null";
        }
        if ($this->container['requester_email'] === null) {
            $invalidProperties[] = "'requester_email' can't be null";
        }
        if ($this->container['self_sign_out_persons'] === null) {
            $invalidProperties[] = "'self_sign_out_persons' can't be null";
        }
     ...
     *
     * @param bool $group_has_auto_accept group_has_auto_accept
     *
     * @return self
     */
     ...
     *
     * @param \ChurchTools\Model\GetBookings200ResponseDataInnerBookingBaseInvolvedPersonsDomainObjectsCreatedBy[] $leader_sign_out_persons leader_sign_out_persons
     *
     * @return self
     */
    public function setLeaderSignOutPersons($leader_sign_out_persons)
    {
        if (is_null($leader_sign_out_persons)) {
            array_push($this->openAPINullablesSetToNull, 'leader_sign_out_persons');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('leader_sign_out_persons', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    /**
     * Gets no_user_created
     *
     * @return bool|null
     */
    public function getNoUserCreated()
    {
        return $this->container['no_user_created'];
    }

    /**
     * Sets no_user_created
     *
     * @param bool|null $no_user_created no_user_created
     *
     * @return self
     */
    public function setNoUserCreated($no_user_created)
    {
        if (is_null($no_user_created)) {
            throw new \InvalidArgumentException('non-nullable no_user_created cannot be null');
        }
        $this->container['no_user_created'] = $no_user_created;
     ...
     * Gets requester
     *
     * @return \ChurchTools\Model\GetPublicGroupSignoutData200ResponseDataRequester
     */
     ...
     * Sets requester
     *
     * @param \ChurchTools\Model\GetPublicGroupSignoutData200ResponseDataRequester $requester requester
     *
     * @return self
     */
     ...
     *
     * @param string $requester_email requester_email
     *
     * @return self
     */
    public function setRequesterEmail($requester_email)
    {
        if (is_null($requester_email)) {
            array_push($this->openAPINullablesSetToNull, 'requester_email');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('requester_email', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param \ChurchTools\Model\PostBookings201ResponseDataInvolvedPersonsDomainObjectsCreatedBy[] $self_sign_out_persons self_sign_out_persons
     *
     * @return self
     */
    public function setSelfSignOutPersons($self_sign_out_persons)
    {
        if (is_null($self_sign_out_persons)) {
            array_push($this->openAPINullablesSetToNull, 'self_sign_out_persons');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('self_sign_out_persons', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
