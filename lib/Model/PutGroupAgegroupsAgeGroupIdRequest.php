...
/**
 * PutGroupAgegroupsAgeGroupIdRequest Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class PutGroupAgegroupsAgeGroupIdRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'put_group_agegroups_ageGroupId_request';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PutGroupAgegroupsAgeGroupIdRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 2)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PutGroupAgegroupsAgeGroupIdRequest., must be bigger than or equal to 2.');
        }
