...
/**
 * GetPersonMasterdata200ResponseDataStatusesInner Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GetPersonMasterdata200ResponseDataStatusesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getPersonMasterdata_200_response_data_statuses_inner';
    ...
    */
     ...
     * Sets is_member
     *
     * @param bool $is_member Flag if status is member of the church
     *
     * @return self
     */
     ...
     * Sets is_searchable
     *
     * @param bool $is_searchable Flag if that status is searchable
     *
     * @return self
     */
     ...
     *
     * @param string $name_translated Translated status name
     *
     * @return self
     */
     ...
     *
     * @param int $security_level_id Only persons with that securitylevel can edit/select/delete that status
     *
     * @return self
     */
     ...
     * Sets shorty
     *
     * @param string $shorty Abbreviation of name.
     *
     * @return self
     */
     ...
     * Sets sort_key
     *
     * @param int $sort_key Used to sort all statuses
     *
     * @return self
     */
