...
/**
 * GetProfilesChurch200ResponseDataServicesInner Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GetProfilesChurch200ResponseDataServicesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_profiles_church_200_response_data_services_inner';
    ...
    */
    ...
    public function setRepetition($repetition)
    {
        ...
        if ((mb_strlen($repetition) < 1)) {
            throw new \InvalidArgumentException('invalid length for $repetition when calling GetProfilesChurch200ResponseDataServicesInner., must be bigger than or equal to 1.');
        }
    ...
    public function setTime($time)
    {
        ...
        if ((mb_strlen($time) < 1)) {
            throw new \InvalidArgumentException('invalid length for $time when calling GetProfilesChurch200ResponseDataServicesInner., must be bigger than or equal to 1.');
        }
