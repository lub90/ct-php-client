...
class Role implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 2)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Role., must be bigger than or equal to 2.');
        }
    ...
    public function setShorty($shorty)
    {
        ...
        if ((mb_strlen($shorty) > 10)) {
            throw new \InvalidArgumentException('invalid length for $shorty when calling Role., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($shorty) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shorty when calling Role., must be bigger than or equal to 1.');
        }
