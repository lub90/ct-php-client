...
/**
 * GroupHomepage2 Class Doc Comment
 *
 * @category Class
 ...
 */
class GroupHomepage2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GroupHomepage_2';
    ...
    protected static $openAPITypes = [
        ...
        'depth' => 'int',
        'filter' => 'mixed',
        'filters' => '\ChurchTools\Model\GroupHomepage1FiltersInner[]',
        'groups' => '\ChurchTools\Model\PublicGroup2[]',
        'id' => 'int',
        'is_enabled' => 'bool',
        'meta' => 'object',
        'order_by' => 'string',
    ...
    public const DEFAULT_VIEW_TILE = 'tile';
    public const DEFAULT_VIEW_MINITILE = 'minitile';
    public const DEFAULT_VIEW__LIST = 'list';
    public const ORDER_BY_NAME = 'name';
    public const ORDER_BY_DATE_OF_FOUNDATION = 'dateOfFoundation';
    ...
    {
        return [
            self::DEFAULT_VIEW_TILE,
            self::DEFAULT_VIEW_MINITILE,
            self::DEFAULT_VIEW__LIST,
        ];
    }
    ...
    public function getOrderByAllowableValues()
    {
        return [
            self::ORDER_BY_NAME,
            self::ORDER_BY_DATE_OF_FOUNDATION,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['show_filters'] === null) {
            $invalidProperties[] = "'show_filters' can't be null";
        }
        if ($this->container['show_group_images'] === null) {
            $invalidProperties[] = "'show_group_images' can't be null";
        }
        if ($this->container['show_leaders'] === null) {
            $invalidProperties[] = "'show_leaders' can't be null";
        }
    ...
    public function setDefaultView($default_view)
    {
        ...
        $allowedValues = $this->getDefaultViewAllowableValues();
        if (!in_array($default_view, $allowedValues, true)) {
     ...
     * Sets depth
     *
     * @param int|null $depth The depth of the group hierarchy that should be displayed on the group homepage.
     *
     * @return self
     */
     ...
     * Gets filters
     *
     * @return \ChurchTools\Model\GroupHomepage1FiltersInner[]
     */
     ...
     * Sets filters
     *
     * @param \ChurchTools\Model\GroupHomepage1FiltersInner[] $filters Specifies all filters that can be applied for this group homepage.
     *
     * @return self
     */
     ...
     * Sets groups
     *
     * @param \ChurchTools\Model\PublicGroup2[] $groups Array of groups to be displayed on the group homepage.
     *
     * @return self
     */
     ...
     * Sets order_by
     *
     * @param string|null $order_by Group field to sort groups by.
     *
     * @return self
     */
     ...
     * Sets show_filter
     *
     * @param mixed|null $show_filter show_filter
     *
     * @return self
     * @deprecated
     */
    public function setShowFilter($show_filter)
    {
        if (is_null($show_filter)) {
            array_push($this->openAPINullablesSetToNull, 'show_filter');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('show_filter', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        return $this->container['show_filters'];
    }

    /**
     * Sets show_filters
     *
     * @param bool $show_filters If true, selected filters are displayed.
     *
     * @return self
     */
    public function setShowFilters($show_filters)
    {
        if (is_null($show_filters)) {
            throw new \InvalidArgumentException('non-nullable show_filters cannot be null');
        }
        $this->container['show_filters'] = $show_filters;
     ...
     * Sets show_leader
     *
     * @param mixed|null $show_leader show_leader
     *
     * @return self
     * @deprecated
     */
    public function setShowLeader($show_leader)
    {
        if (is_null($show_leader)) {
            array_push($this->openAPINullablesSetToNull, 'show_leader');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('show_leader', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * @return bool
     */
    public function getShowLeaders()
    {
        return $this->container['show_leaders'];
    }

    /**
     * Sets show_leaders
     *
     * @param bool $show_leaders If true, the group homepage is set to display the leaders of each group.
     *
     * @return self
     */
    public function setShowLeaders($show_leaders)
    {
        if (is_null($show_leaders)) {
            throw new \InvalidArgumentException('non-nullable show_leaders cannot be null');
        }
        $this->container['show_leaders'] = $show_leaders;
     ...
     * Sets sort_by
     *
     * @param mixed|null $sort_by sort_by
     *
     * @return self
     */
