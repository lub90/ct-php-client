...
/**
 * PostPersonsAbsencesRequest Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class PostPersonsAbsencesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_persons_absences_request';
    ...
    */
    ...
    public function setAbsenceReasonId($absence_reason_id)
    {
        if (is_null($absence_reason_id)) {
            throw new \InvalidArgumentException('non-nullable absence_reason_id cannot be null');
        }
