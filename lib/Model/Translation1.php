 ...
 */
class Translation1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Translation_1';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('updated_by_church', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets translation
     *
     * @param string|null $translation The translation value for the key
     *
     * @return self
     */
    ...
    {
        if (is_null($updated_by_church)) {
            throw new \InvalidArgumentException('non-nullable updated_by_church cannot be null');
        }
