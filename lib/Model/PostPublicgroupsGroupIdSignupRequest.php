...
/**
 * PostPublicgroupsGroupIdSignupRequest Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class PostPublicgroupsGroupIdSignupRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_publicgroups_groupId_signup_request';
    ...
    protected static $openAPITypes = [
        'forms' => '\ChurchTools\Model\PostPublicgroupsGroupIdSignupRequestFormsInner[]',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('sign_out_url_template', $data ?? [], null);
    ...
    */
     ...
     * Gets forms
     *
     * @return \ChurchTools\Model\PostPublicgroupsGroupIdSignupRequestFormsInner[]
     */
     ...
     * Sets forms
     *
     * @param \ChurchTools\Model\PostPublicgroupsGroupIdSignupRequestFormsInner[] $forms A list of form data containing a form object for each person that should be signed up.
     *
     * @return self
     */
    ...
    {
        if (is_null($sign_out_url_template)) {
            throw new \InvalidArgumentException('non-nullable sign_out_url_template cannot be null');
        }
