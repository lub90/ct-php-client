...
/**
 * CreateNewAccountRequest Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class CreateNewAccountRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createNewAccount_request';
    ...
    */
    ...
    public function setAccountGroupId($account_group_id)
    {
        if (is_null($account_group_id)) {
            array_push($this->openAPINullablesSetToNull, 'account_group_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('account_group_id', $nullablesSetToNull);
            if ($index !== FALSE) {
