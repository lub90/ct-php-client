...
/**
 * PatchGroupsGroupIdMembersPersonIdRequest Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class PatchGroupsGroupIdMembersPersonIdRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patch_groups_groupId_members_personId_request';
    ...
    */
     ...
     *
     * @param \DateTime|null $member_start_date Must be set for an active membership, optional otherwise.
     *
     * @return self
     */
