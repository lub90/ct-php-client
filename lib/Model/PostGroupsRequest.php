...
class PostGroupsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param int|null $group_category_id ID of group category
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PostGroupsRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 1)) {
     ...
     *
     * @param int|null $parent_group_id Group ID of parent group
     *
     * @return self
     */
     ...
     * Sets role_id
     *
     * @param int|null $role_id put yourself in this role
     *
     * @return self
     */
     ...
     * Sets visibility
     *
     * @param string|null $visibility The visibility of a group.
     *
     * @return self
     */
