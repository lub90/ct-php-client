...
/**
 * PostPublicgroupsGroupIdSignup200Response Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class PostPublicgroupsGroupIdSignup200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_publicgroups_groupId_signup_200_response';
    ...
    {
        $this->setIfExists('group_homepage_hash', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($group_homepage_hash)) {
            throw new \InvalidArgumentException('non-nullable group_homepage_hash cannot be null');
        }
