...
class SyncLogEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'id' => 'int',
        'is_dry_run' => 'bool',
        'job' => '\ChurchTools\Model\SyncLogEntryJob',
        'level' => 'string',
        'message_args' => 'object',
        'message_i18n' => 'string',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['message_i18n'] === null) {
            $invalidProperties[] = "'message_i18n' can't be null";
        }
        if ((mb_strlen($this->container['message_i18n']) < 1)) {
     ...
     * Gets job
     *
     * @return \ChurchTools\Model\SyncLogEntryJob
     */
     ...
     * Sets job
     *
     * @param \ChurchTools\Model\SyncLogEntryJob $job job
     *
     * @return self
     */
