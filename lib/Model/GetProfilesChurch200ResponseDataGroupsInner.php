<?php
/**
 * GetProfilesChurch200ResponseDataGroupsInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * GetProfilesChurch200ResponseDataGroupsInner Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GetProfilesChurch200ResponseDataGroupsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_profiles_church_200_response_data_groups_inner';
    ...
    */
    ...
    public function setGroupHomepageApi($group_homepage_api)
    {
        ...
        if (!is_null($group_homepage_api) && (mb_strlen($group_homepage_api) < 1)) {
            throw new \InvalidArgumentException('invalid length for $group_homepage_api when calling GetProfilesChurch200ResponseDataGroupsInner., must be bigger than or equal to 1.');
        }
    ...
    public function setGroupHomepageUrl($group_homepage_url)
    {
        ...
        if (!is_null($group_homepage_url) && (mb_strlen($group_homepage_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $group_homepage_url when calling GetProfilesChurch200ResponseDataGroupsInner., must be bigger than or equal to 1.');
        }
