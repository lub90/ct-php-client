...
class GetFilesMetadata200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        ...
        'modified_date' => true,
        'modified_pid' => true,
        'securitylevel_id' => true,
        'showonlywheneditable_yn' => true,
        'sortkey' => true,
        'url' => true
    ];
    ...
    */
    ...
    public function setDeletionDate($deletion_date)
    {
        if (is_null($deletion_date)) {
            array_push($this->openAPINullablesSetToNull, 'deletion_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('deletion_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setSecuritylevelId($securitylevel_id)
    {
        if (is_null($securitylevel_id)) {
            array_push($this->openAPINullablesSetToNull, 'securitylevel_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('securitylevel_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setShowonlywheneditableYn($showonlywheneditable_yn)
    {
        if (is_null($showonlywheneditable_yn)) {
            array_push($this->openAPINullablesSetToNull, 'showonlywheneditable_yn');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('showonlywheneditable_yn', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
