...
/**
 * PostFilesDomainTypeDomainIdentifierLinkRequest Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class PostFilesDomainTypeDomainIdentifierLinkRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_files_domainType_domainIdentifier_link_request';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PostFilesDomainTypeDomainIdentifierLinkRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $url when calling PostFilesDomainTypeDomainIdentifierLinkRequest., must be smaller than or equal to 255.');
        }
