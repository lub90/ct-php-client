...
/**
 * PostRoutinesRequest Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class PostRoutinesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_routines_request';
    ...
    protected static $openAPITypes = [
        'description' => 'string',
        'domain_context' => '\ChurchTools\Model\PostRoutinesRequestDomainContext',
        'domain_type' => 'string',
        'is_enabled' => 'bool',
        'name' => 'string',
        'priority' => 'int'
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PostRoutinesRequest., must be smaller than or equal to 1000.');
        }
     ...
     * Gets domain_context
     *
     * @return \ChurchTools\Model\PostRoutinesRequestDomainContext|null
     */
     ...
     * Sets domain_context
     *
     * @param \ChurchTools\Model\PostRoutinesRequestDomainContext|null $domain_context domain_context
     *
     * @return self
     */
