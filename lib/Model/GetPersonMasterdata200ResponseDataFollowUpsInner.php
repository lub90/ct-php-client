<?php
/**
 * GetPersonMasterdata200ResponseDataFollowUpsInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * GetPersonMasterdata200ResponseDataFollowUpsInner Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GetPersonMasterdata200ResponseDataFollowUpsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getPersonMasterdata_200_response_data_followUps_inner';
    ...
    */
    ...
    public function setCommentViewerId($comment_viewer_id)
    {
        if (is_null($comment_viewer_id)) {
            throw new \InvalidArgumentException('non-nullable comment_viewer_id cannot be null');
        }
