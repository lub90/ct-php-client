...
class GetPersonMasterdata200ResponseMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'age_groups' => true,
        'campuses' => true,
        'comment_viewers' => true,
        'contact_labels' => true,
        'departments' => true,
        'follow_up_intervals' => true,
        'follow_ups' => true,
        'group_categories' => true,
        'group_meeting_templates' => true,
        'group_statuses' => true,
        'group_types' => true,
        'grow_paths' => true,
        'roles' => true,
    ...
    */
    ...
    public function setAgeGroups($age_groups)
    {
        if (is_null($age_groups)) {
            array_push($this->openAPINullablesSetToNull, 'age_groups');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('age_groups', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    {
        if (is_null($campuses)) {
            array_push($this->openAPINullablesSetToNull, 'campuses');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('campuses', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param int|null $comment_viewers comment_viewers
     *
     * @return self
     */
    public function setCommentViewers($comment_viewers)
    {
        if (is_null($comment_viewers)) {
            array_push($this->openAPINullablesSetToNull, 'comment_viewers');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('comment_viewers', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setContactLabels($contact_labels)
    {
        if (is_null($contact_labels)) {
            array_push($this->openAPINullablesSetToNull, 'contact_labels');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('contact_labels', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setFollowUpIntervals($follow_up_intervals)
    {
        if (is_null($follow_up_intervals)) {
            array_push($this->openAPINullablesSetToNull, 'follow_up_intervals');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('follow_up_intervals', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setFollowUps($follow_ups)
    {
        if (is_null($follow_ups)) {
            array_push($this->openAPINullablesSetToNull, 'follow_ups');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('follow_ups', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setGroupCategories($group_categories)
    {
        if (is_null($group_categories)) {
            array_push($this->openAPINullablesSetToNull, 'group_categories');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('group_categories', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setGroupMeetingTemplates($group_meeting_templates)
    {
        if (is_null($group_meeting_templates)) {
            array_push($this->openAPINullablesSetToNull, 'group_meeting_templates');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('group_meeting_templates', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setGroupStatuses($group_statuses)
    {
        if (is_null($group_statuses)) {
            array_push($this->openAPINullablesSetToNull, 'group_statuses');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('group_statuses', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setGroupTypes($group_types)
    {
        if (is_null($group_types)) {
            array_push($this->openAPINullablesSetToNull, 'group_types');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('group_types', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setGrowPaths($grow_paths)
    {
        if (is_null($grow_paths)) {
            array_push($this->openAPINullablesSetToNull, 'grow_paths');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('grow_paths', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setTargetGroups($target_groups)
    {
        if (is_null($target_groups)) {
            array_push($this->openAPINullablesSetToNull, 'target_groups');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('target_groups', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
