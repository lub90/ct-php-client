...
/**
 * CustomModuleDataCategoryCreate Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class CustomModuleDataCategoryCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomModuleDataCategoryCreate';
    ...
    */
    ...
    public function setCustomModuleId($custom_module_id)
    {
        if (is_null($custom_module_id)) {
            throw new \InvalidArgumentException('non-nullable custom_module_id cannot be null');
        }
