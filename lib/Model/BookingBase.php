 ...
 */
class BookingBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BookingBase';
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $description when calling BookingBase., must be smaller than or equal to 4096.');
        }
    ...
    public function setSubtitle($subtitle)
    {
        ...
        if (!is_null($subtitle) && (mb_strlen($subtitle) > 255)) {
            throw new \InvalidArgumentException('invalid length for $subtitle when calling BookingBase., must be smaller than or equal to 255.');
        }
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 255)) {
            throw new \InvalidArgumentException('invalid length for $title when calling BookingBase., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($title) < 1)) {
            throw new \InvalidArgumentException('invalid length for $title when calling BookingBase., must be bigger than or equal to 1.');
        }
