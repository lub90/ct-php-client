 ...
 */
class WikiPage2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WikiPage_2';
    ...
    protected static $openAPITypes = [
        ...
        'on_startpage' => 'bool',
        'permissions' => '\ChurchTools\Model\WikiPage1Permissions',
        'redirect_to' => 'string',
        'text' => 'string',
        'title' => 'string',
        'version' => 'int',
        'wiki_category' => '\ChurchTools\Model\WikiCategory2'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_markdown'] === null) {
            $invalidProperties[] = "'is_markdown' can't be null";
        }
        if ($this->container['meta'] === null) {
            $invalidProperties[] = "'meta' can't be null";
        }
        if ($this->container['on_startpage'] === null) {
            $invalidProperties[] = "'on_startpage' can't be null";
        }
        ...
        if ($this->container['wiki_category'] === null) {
            $invalidProperties[] = "'wiki_category' can't be null";
        }
     ...
     * Gets permissions
     *
     * @return \ChurchTools\Model\WikiPage1Permissions|null
     */
     ...
     * Sets permissions
     *
     * @param \ChurchTools\Model\WikiPage1Permissions|null $permissions permissions
     *
     * @return self
     */
    ...
    public function setRedirectTo($redirect_to)
    {
        if (is_null($redirect_to)) {
            array_push($this->openAPINullablesSetToNull, 'redirect_to');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('redirect_to', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets wiki_category
     *
     * @return \ChurchTools\Model\WikiCategory2
     */
     ...
     * Sets wiki_category
     *
     * @param \ChurchTools\Model\WikiCategory2 $wiki_category wiki_category
     *
     * @return self
     */
