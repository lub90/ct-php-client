...
/**
 * PostFinanceTurnoverReportRequest Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class PostFinanceTurnoverReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_finance_turnover_report_request';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('show_empty_accounts', $data ?? [], false);
    }
    ...
    */
     ...
     *
     * @param float $accounting_period_id ID of Accounting Period
     *
     * @return self
     */
     ...
     * Sets period
     *
     * @param string $period Select monthly oder quarterly report
     *
     * @return self
     */
