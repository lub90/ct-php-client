...
class GetPublicgroup200ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'id' => 'int',
        'information' => '\ChurchTools\Model\GetPublicgroup200ResponseDataInformation',
        'max_member_count' => 'int',
        'name' => 'string',
        'requested_places_count' => 'int',
        'requested_waitinglist_places_count' => 'int',
        'settings' => '\ChurchTools\Model\GetPublicgroup200ResponseDataSettings',
        'sign_up_conditions' => '\ChurchTools\Model\GetPublicgroup200ResponseDataSignUpConditions',
        'sign_up_headline' => 'string',
        'sign_up_persons' => '\ChurchTools\Model\GetPublicgroup200ResponseDataSignUpPersonsInner[]',
    ...
    protected static array $openAPINullables = [
        ...
        'auto_accept' => false,
        'can_sign_up' => false,
        'current_member_count' => true,
        'id' => true,
        'information' => false,
        'max_member_count' => true,
        'name' => true,
        'requested_places_count' => true,
        'requested_waitinglist_places_count' => true,
        'settings' => false,
    ...
    */
    ...
    public function setCurrentMemberCount($current_member_count)
    {
        if (is_null($current_member_count)) {
            array_push($this->openAPINullablesSetToNull, 'current_member_count');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('current_member_count', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Gets information
     *
     * @return \ChurchTools\Model\GetPublicgroup200ResponseDataInformation|null
     */
     ...
     * Sets information
     *
     * @param \ChurchTools\Model\GetPublicgroup200ResponseDataInformation|null $information information
     *
     * @return self
     */
    ...
    public function setMaxMemberCount($max_member_count)
    {
        if (is_null($max_member_count)) {
            array_push($this->openAPINullablesSetToNull, 'max_member_count');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('max_member_count', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setRequestedPlacesCount($requested_places_count)
    {
        if (is_null($requested_places_count)) {
            array_push($this->openAPINullablesSetToNull, 'requested_places_count');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('requested_places_count', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setRequestedWaitinglistPlacesCount($requested_waitinglist_places_count)
    {
        if (is_null($requested_waitinglist_places_count)) {
            array_push($this->openAPINullablesSetToNull, 'requested_waitinglist_places_count');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('requested_waitinglist_places_count', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets settings
     *
     * @return \ChurchTools\Model\GetPublicgroup200ResponseDataSettings|null
     */
     ...
     * Sets settings
     *
     * @param \ChurchTools\Model\GetPublicgroup200ResponseDataSettings|null $settings settings
     *
     * @return self
     */
     ...
     *
     * @return \ChurchTools\Model\GetPublicgroup200ResponseDataSignUpConditions|null
     */
     ...
     *
     * @param \ChurchTools\Model\GetPublicgroup200ResponseDataSignUpConditions|null $sign_up_conditions sign_up_conditions
     *
     * @return self
     */
     ...
     *
     * @return \ChurchTools\Model\GetPublicgroup200ResponseDataSignUpPersonsInner[]|null
     */
     ...
     *
     * @param \ChurchTools\Model\GetPublicgroup200ResponseDataSignUpPersonsInner[]|null $sign_up_persons sign_up_persons
     *
     * @return self
     */
