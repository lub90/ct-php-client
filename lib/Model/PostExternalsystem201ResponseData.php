...
/**
 * PostExternalsystem201ResponseData Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class PostExternalsystem201ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_externalsystem_201_response_data';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PostExternalsystem201ResponseData., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($name) < 2)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PostExternalsystem201ResponseData., must be bigger than or equal to 2.');
        }
    ...
    public function setNamePlural($name_plural)
    {
        ...
        if ((mb_strlen($name_plural) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name_plural when calling PostExternalsystem201ResponseData., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($name_plural) < 2)) {
            throw new \InvalidArgumentException('invalid length for $name_plural when calling PostExternalsystem201ResponseData., must be bigger than or equal to 2.');
        }
