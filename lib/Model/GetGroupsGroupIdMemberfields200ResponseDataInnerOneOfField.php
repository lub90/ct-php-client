...
/**
 * GetGroupsGroupIdMemberfields200ResponseDataInnerOneOfField Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GetGroupsGroupIdMemberfields200ResponseDataInnerOneOfField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_groups_groupId_memberfields_200_response_data_inner_oneOf_field';
    ...
    protected static $openAPITypes = [
        'db_field' => '\ChurchTools\Model\PostDbfields201ResponseData',
    ...
    {
        $this->setIfExists('db_field', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['db_field'] === null) {
            $invalidProperties[] = "'db_field' can't be null";
        }
     ...
     * Sets db_field
     *
     * @param \ChurchTools\Model\PostDbfields201ResponseData $db_field db_field
     *
     * @return self
     */
    ...
    {
        if (is_null($db_field)) {
            throw new \InvalidArgumentException('non-nullable db_field cannot be null');
        }
