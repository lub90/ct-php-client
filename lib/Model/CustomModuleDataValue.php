...
/**
 * CustomModuleDataValue Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class CustomModuleDataValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomModuleDataValue';
    ...
    */
    ...
    public function setDataCategoryId($data_category_id)
    {
        if (is_null($data_category_id)) {
            array_push($this->openAPINullablesSetToNull, 'data_category_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('data_category_id', $nullablesSetToNull);
            if ($index !== FALSE) {
