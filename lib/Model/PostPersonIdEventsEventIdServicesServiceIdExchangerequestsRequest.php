...
/**
 * PostPersonIdEventsEventIdServicesServiceIdExchangerequestsRequest Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class PostPersonIdEventsEventIdServicesServiceIdExchangerequestsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_personId_events_eventId_services_serviceId_exchangerequests_request';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'is_archived' => 'bool',
        'meta' => '\ChurchTools\Model\PostPersonIdEventsEventIdServicesServiceIdExchangerequestsRequestMeta',
        'requested_event' => '\ChurchTools\Model\GetAllForService200ResponseInnerRequestingEvent',
        'requested_person' => '\ChurchTools\Model\PostCheckinPersons201ResponseData',
        'requested_service_id' => 'int',
        'requesting_event' => '\ChurchTools\Model\GetAllForService200ResponseInnerRequestingEvent',
        'requesting_person' => '\ChurchTools\Model\PostCheckinPersons201ResponseData',
    ...
    protected static array $openAPINullables = [
        ...
        'requested_service_id' => true,
        'requesting_event' => false,
        'requesting_person' => false,
        'requesting_service_id' => true,
        'status' => true
    ];
    ...
    */
     ...
     * Gets meta
     *
     * @return \ChurchTools\Model\PostPersonIdEventsEventIdServicesServiceIdExchangerequestsRequestMeta|null
     */
     ...
     * Sets meta
     *
     * @param \ChurchTools\Model\PostPersonIdEventsEventIdServicesServiceIdExchangerequestsRequestMeta|null $meta meta
     *
     * @return self
     */
     ...
     *
     * @return \ChurchTools\Model\GetAllForService200ResponseInnerRequestingEvent|null
     */
     ...
     *
     * @param \ChurchTools\Model\GetAllForService200ResponseInnerRequestingEvent|null $requested_event requested_event
     *
     * @return self
     */
     ...
     *
     * @return \ChurchTools\Model\PostCheckinPersons201ResponseData|null
     */
     ...
     *
     * @param \ChurchTools\Model\PostCheckinPersons201ResponseData|null $requested_person requested_person
     *
     * @return self
     */
    ...
    public function setRequestedServiceId($requested_service_id)
    {
        if (is_null($requested_service_id)) {
            array_push($this->openAPINullablesSetToNull, 'requested_service_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('requested_service_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param \ChurchTools\Model\GetAllForService200ResponseInnerRequestingEvent|null $requesting_event requesting_event
     *
     * @return self
     */
     ...
     *
     * @param \ChurchTools\Model\PostCheckinPersons201ResponseData|null $requesting_person requesting_person
     *
     * @return self
     */
    ...
    public function setRequestingServiceId($requesting_service_id)
    {
        if (is_null($requesting_service_id)) {
            array_push($this->openAPINullablesSetToNull, 'requesting_service_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('requesting_service_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
