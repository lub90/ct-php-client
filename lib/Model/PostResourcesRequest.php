...
/**
 * PostResourcesRequest Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class PostResourcesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_resources_request';
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PostResourcesRequest., must be smaller than or equal to 1000.');
        }
    ...
    public function setICalLocation($i_cal_location)
    {
        ...
        if (!is_null($i_cal_location) && (mb_strlen($i_cal_location) > 100)) {
            throw new \InvalidArgumentException('invalid length for $i_cal_location when calling PostResourcesRequest., must be smaller than or equal to 100.');
        }
    ...
    public function setLocation($location)
    {
        ...
        if (!is_null($location) && (mb_strlen($location) > 100)) {
            throw new \InvalidArgumentException('invalid length for $location when calling PostResourcesRequest., must be smaller than or equal to 100.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PostResourcesRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 2)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PostResourcesRequest., must be bigger than or equal to 2.');
        }
    ...
    public function setRandomString($random_string)
    {
        ...
        if (!is_null($random_string) && (mb_strlen($random_string) > 100)) {
            throw new \InvalidArgumentException('invalid length for $random_string when calling PostResourcesRequest., must be smaller than or equal to 100.');
        }
