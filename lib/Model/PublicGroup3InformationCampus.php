...
/**
 * PublicGroup3InformationCampus Class Doc Comment
 *
 * @category Class
 ...
 */
class PublicGroup3InformationCampus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicGroup_3_information_campus';
    ...
    */
     ...
     * Sets address
     *
     * @param \ChurchTools\Model\AppointmentCreateAllOfAddress|null $address address
     *
     * @return self
     */
    ...
    public function setGuid($guid)
    {
        ...
        if ((mb_strlen($guid) < 1)) {
            throw new \InvalidArgumentException('invalid length for $guid when calling PublicGroup3InformationCampus., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PublicGroup3InformationCampus., must be bigger than or equal to 1.');
        }
    ...
    public function setNameTranslated($name_translated)
    {
        ...
        if ((mb_strlen($name_translated) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name_translated when calling PublicGroup3InformationCampus., must be bigger than or equal to 1.');
        }
    ...
    public function setShortName($short_name)
    {
        ...
        if ((mb_strlen($short_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $short_name when calling PublicGroup3InformationCampus., must be bigger than or equal to 0.');
        }
    ...
    public function setShorty($shorty)
    {
        ...
        if ((mb_strlen($shorty) < 1)) {
            throw new \InvalidArgumentException('invalid length for $shorty when calling PublicGroup3InformationCampus., must be bigger than or equal to 1.');
        }
