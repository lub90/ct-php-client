...
/**
 * PatchPersonsPersonidMergeDuplicateidRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchPersonsPersonidMergeDuplicateidRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'patch_persons_personid_merge_duplicateid_request';
    ...
    protected static $openAPITypes = [
        ...
        'department_ids' => 'int[]',
        'email' => 'string',
        'emails' => '\ChurchTools\Model\PersonEmail1[]',
        ...
        'privacy_policy_agreement' => '\ChurchTools\Model\CreatePersonRequestPrivacyPolicyAgreement',
        'referred_by' => 'string',
        'referred_to' => 'string',
        'sex_id' => 'int',
        'status_id' => 'int',
    ...
    */
     ...
     * Gets emails
     *
     * @return \ChurchTools\Model\PersonEmail1[]|null
     */
     ...
     * Sets emails
     *
     * @param \ChurchTools\Model\PersonEmail1[]|null $emails Save many eMail addresses for person. If `emails` is present in request `email` is ignored.
     *
     * @return self
     */
     ...
     * Sets optigem_id
     *
     * @param string|null $optigem_id optigem_id
     *
     * @return self
     */
    public function setOptigemId($optigem_id)
    {
        if (is_null($optigem_id)) {
            array_push($this->openAPINullablesSetToNull, 'optigem_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('optigem_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @return \ChurchTools\Model\CreatePersonRequestPrivacyPolicyAgreement|null
     */
     ...
     *
     * @param \ChurchTools\Model\CreatePersonRequestPrivacyPolicyAgreement|null $privacy_policy_agreement privacy_policy_agreement
     *
     * @return self
     */
