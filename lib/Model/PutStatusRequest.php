...
/**
 * PutStatusRequest Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class PutStatusRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'putStatus_request';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PutStatusRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($name) < 2)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PutStatusRequest., must be bigger than or equal to 2.');
        }
    ...
    public function setShorty($shorty)
    {
        ...
        if ((mb_strlen($shorty) > 50)) {
            throw new \InvalidArgumentException('invalid length for $shorty when calling PutStatusRequest., must be smaller than or equal to 50.');
        }
