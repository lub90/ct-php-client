<?php
/**
 * UpdateCampusRequestGroupsInnerGroup
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * UpdateCampusRequestGroupsInnerGroup Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class UpdateCampusRequestGroupsInnerGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_campus_request_groups_inner_group';
    ...
    */
    ...
    public function setDomainIdentifier($domain_identifier)
    {
        ...
        if ((mb_strlen($domain_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $domain_identifier when calling UpdateCampusRequestGroupsInnerGroup., must be bigger than or equal to 1.');
        }
