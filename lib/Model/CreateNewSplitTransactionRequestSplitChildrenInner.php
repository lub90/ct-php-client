...
/**
 * CreateNewSplitTransactionRequestSplitChildrenInner Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class CreateNewSplitTransactionRequestSplitChildrenInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createNewSplitTransaction_request_splitChildren_inner';
    ...
    protected static $openAPITypes = [
        ...
        'donator' => '\ChurchTools\Model\GetBookings200ResponseDataInnerBookingBaseInvolvedPersonsDomainObjectsCreatedBy',
        'donator_spouse' => '\ChurchTools\Model\GetBookings200ResponseDataInnerBookingBaseInvolvedPersonsDomainObjectsCreatedBy',
        'id' => 'int',
        'is_immutable' => 'bool',
        'is_synced' => 'bool',
        ...
        'note' => 'string',
        'permissions' => '\ChurchTools\Model\CreateNewSplitTransactionRequestSplitChildrenInnerPermissions',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_immutable'] === null) {
            $invalidProperties[] = "'is_immutable' can't be null";
        }
        if ($this->container['is_synced'] === null) {
            $invalidProperties[] = "'is_synced' can't be null";
        }
        if ($this->container['is_waiver_of_reimbursement_of_expenses'] === null) {
            $invalidProperties[] = "'is_waiver_of_reimbursement_of_expenses' can't be null";
        }
     ...
     * Sets donator
     *
     * @param \ChurchTools\Model\GetBookings200ResponseDataInnerBookingBaseInvolvedPersonsDomainObjectsCreatedBy|null $donator donator
     *
     * @return self
     */
    ...
    {
        if (is_null($donator)) {
            array_push($this->openAPINullablesSetToNull, 'donator');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('donator', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets donator_spouse
     *
     * @param \ChurchTools\Model\GetBookings200ResponseDataInnerBookingBaseInvolvedPersonsDomainObjectsCreatedBy|null $donator_spouse donator_spouse
     *
     * @return self
     */
    public function setDonatorSpouse($donator_spouse)
    {
        if (is_null($donator_spouse)) {
            array_push($this->openAPINullablesSetToNull, 'donator_spouse');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('donator_spouse', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets is_synced
     *
     * @param bool $is_synced True, if the transaction has been created through a sync.
     *
     * @return self
     */
     ...
     *
     * @param bool $is_waiver_of_reimbursement_of_expenses is_waiver_of_reimbursement_of_expenses
     *
     * @return self
     */
     ...
     * Gets permissions
     *
     * @return \ChurchTools\Model\CreateNewSplitTransactionRequestSplitChildrenInnerPermissions|null
     */
     ...
     * Sets permissions
     *
     * @param \ChurchTools\Model\CreateNewSplitTransactionRequestSplitChildrenInnerPermissions|null $permissions permissions
     *
     * @return self
     */
