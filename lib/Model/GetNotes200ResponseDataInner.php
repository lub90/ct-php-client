...
/**
 * GetNotes200ResponseDataInner Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GetNotes200ResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_notes_200_response_data_inner';
    ...
    protected static $openAPITypes = [
        ...
        'domain_type' => 'string',
        'id' => 'int',
        'links' => '\ChurchTools\Model\GetNotes200ResponseDataInnerAllOfLinks',
        'meta' => '\ChurchTools\Model\GetNotes200ResponseDataInnerAllOfMeta'
    ];
    ...
    public const DOMAIN_TYPE_FOLLOW_UP = 'follow_up';
    public const DOMAIN_TYPE_GROUP = 'group';
    public const DOMAIN_TYPE_PERSON = 'person';
    public const DOMAIN_TYPE_SONG_ARRANGEMENT = 'song_arrangement';
    ...
    {
        return [
            self::DOMAIN_TYPE_FOLLOW_UP,
            self::DOMAIN_TYPE_GROUP,
            self::DOMAIN_TYPE_PERSON,
            self::DOMAIN_TYPE_SONG_ARRANGEMENT,
        ];
    }
    ...
    */
     ...
     *
     * @param int $comment_viewer_id comment_viewer_id
     *
     * @return self
     */
     ...
     * Sets domain_type
     *
     * @param string $domain_type Domain types that notes can be used with
     *
     * @return self
     */
     ...
     * Gets links
     *
     * @return \ChurchTools\Model\GetNotes200ResponseDataInnerAllOfLinks
     */
     ...
     * Sets links
     *
     * @param \ChurchTools\Model\GetNotes200ResponseDataInnerAllOfLinks $links links
     *
     * @return self
     */
     ...
     * Gets meta
     *
     * @return \ChurchTools\Model\GetNotes200ResponseDataInnerAllOfMeta
     */
     ...
     * Sets meta
     *
     * @param \ChurchTools\Model\GetNotes200ResponseDataInnerAllOfMeta $meta meta
     *
     * @return self
     */
