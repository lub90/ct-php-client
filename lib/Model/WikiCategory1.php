...
/**
 * WikiCategory1 Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  ChurchTools
 ...
 */
class WikiCategory1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WikiCategory_1';
    ...
    protected static array $openAPINullables = [
        'campus_id' => true,
        'file_access_without_permission' => false,
        'id' => true,
        'in_menu' => false,
        'name' => true,
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('file_access_without_permission', $data ?? [], null);
        $this->setIfExists('id', $data ?? [], null);
        $this->setIfExists('in_menu', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($file_access_without_permission)) {
            throw new \InvalidArgumentException('non-nullable file_access_without_permission cannot be null');
        }
    ...
    {
        if (is_null($in_menu)) {
            throw new \InvalidArgumentException('non-nullable in_menu cannot be null');
        }
