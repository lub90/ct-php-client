...
/**
 * GetFilesDomainTypeDomainIdentifier200ResponseDataInner Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GetFilesDomainTypeDomainIdentifier200ResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_files_domainType_domainIdentifier_200_response_data_inner';
    ...
    protected static $openAPITypes = [
        ...
        'filename' => 'string',
        'id' => 'int',
        'image_option' => '\ChurchTools\Model\GetFilesDomainTypeDomainIdentifier200ResponseDataInnerImageOption',
        'image_url' => 'string',
        'meta' => '\ChurchTools\Model\GetFilesDomainTypeDomainIdentifier200ResponseDataInnerMeta',
        'name' => 'string',
        'relative_url' => 'string',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('image_option', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['additional_infos'] === null) {
            $invalidProperties[] = "'additional_infos' can't be null";
        }
        ...
        if ($this->container['image_option'] === null) {
            $invalidProperties[] = "'image_option' can't be null";
        }
        ...
        if ($this->container['relative_url'] === null) {
            $invalidProperties[] = "'relative_url' can't be null";
        }
        if ($this->container['security_level_id'] === null) {
            $invalidProperties[] = "'security_level_id' can't be null";
        }
        if ($this->container['show_only_when_editable'] === null) {
            $invalidProperties[] = "'show_only_when_editable' can't be null";
        }
     ...
     *
     * @param string[] $additional_infos additional_infos
     *
     * @return self
     */
    public function setAdditionalInfos($additional_infos)
    {
        if (is_null($additional_infos)) {
            throw new \InvalidArgumentException('non-nullable additional_infos cannot be null');
        }
     ...
     * Gets image_option
     *
     * @return \ChurchTools\Model\GetFilesDomainTypeDomainIdentifier200ResponseDataInnerImageOption
     */
    public function getImageOption()
    {
        return $this->container['image_option'];
    }

    /**
     * Sets image_option
     *
     * @param \ChurchTools\Model\GetFilesDomainTypeDomainIdentifier200ResponseDataInnerImageOption $image_option image_option
     *
     * @return self
     */
    public function setImageOption($image_option)
    {
        if (is_null($image_option)) {
            throw new \InvalidArgumentException('non-nullable image_option cannot be null');
        }
        $this->container['image_option'] = $image_option;
     ...
     * Gets meta
     *
     * @return \ChurchTools\Model\GetFilesDomainTypeDomainIdentifier200ResponseDataInnerMeta
     */
     ...
     * Sets meta
     *
     * @param \ChurchTools\Model\GetFilesDomainTypeDomainIdentifier200ResponseDataInnerMeta $meta meta
     *
     * @return self
     */
