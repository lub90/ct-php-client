...
class IssueSignUpTokenRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('sign_up_url_template', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($sign_up_url_template)) {
            throw new \InvalidArgumentException('non-nullable sign_up_url_template cannot be null');
        }
