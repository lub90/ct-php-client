...
/**
 * ProfileUpdateTeamInner Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class ProfileUpdateTeamInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProfileUpdate_team_inner';
    ...
    protected static $openAPITypes = [
        'note' => 'string',
        'person' => '\ChurchTools\Model\UpdateCampusRequestTeamInnerPerson',
        'person_id' => 'int',
        'sort_key' => 'int'
    ];
    ...
    */
    ...
    public function setNote($note)
    {
        ...
        if ((mb_strlen($note) < 1)) {
            throw new \InvalidArgumentException('invalid length for $note when calling ProfileUpdateTeamInner., must be bigger than or equal to 1.');
        }
     ...
     * Gets person
     *
     * @return \ChurchTools\Model\UpdateCampusRequestTeamInnerPerson|null
     */
     ...
     * Sets person
     *
     * @param \ChurchTools\Model\UpdateCampusRequestTeamInnerPerson|null $person person
     *
     * @return self
     */
