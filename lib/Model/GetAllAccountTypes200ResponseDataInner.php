<?php
/**
 * GetAllAccountTypes200ResponseDataInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * GetAllAccountTypes200ResponseDataInner Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class GetAllAccountTypes200ResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getAllAccountTypes_200_response_data_inner';
    ...
    public const BALANCE_TYPE_ASSETS = 'assets';
    public const BALANCE_TYPE_LIABILITIES = 'liabilities';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_balance_account', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($is_balance_account)) {
            throw new \InvalidArgumentException('non-nullable is_balance_account cannot be null');
        }
