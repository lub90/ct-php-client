...
/**
 * EventFact1 Class Doc Comment
 *
 * @category Class
 * @description Fact entry for an event
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EventFact1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EventFact_1';
    ...
    protected static $openAPITypes = [
        ...
        'modified_pid' => 'int',
        'value' => '\ChurchTools\Model\PostDbfields201ResponseDataAllOfOptionsInnerAllOfId'
    ];
    ...
    */
    ...
    {
        if (is_null($fact_id)) {
            array_push($this->openAPINullablesSetToNull, 'fact_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('fact_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets modified_pid
     *
     * @param int $modified_pid modified_pid
     *
     * @return self
     * @deprecated
     */
     ...
     * Gets value
     *
     * @return \ChurchTools\Model\PostDbfields201ResponseDataAllOfOptionsInnerAllOfId
     */
     ...
     * Sets value
     *
     * @param \ChurchTools\Model\PostDbfields201ResponseDataAllOfOptionsInnerAllOfId $value value
     *
     * @return self
     */
