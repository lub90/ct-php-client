...
/**
 * PostFactsRequest Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class PostFactsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_facts_request';
    ...
    */
     ...
     * Sets options
     *
     * @param mixed[]|null $options Will not be saved if fieldType = number
     *
     * @return self
     */
