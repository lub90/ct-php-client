...
/**
 * CreateNewTransactionPurposeRequest Class Doc Comment
 *
 * @category Class
 * @package  ChurchTools
 * @author   OpenAPI Generator team
 ...
 */
class CreateNewTransactionPurposeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createNewTransactionPurpose_request';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateNewTransactionPurposeRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 2)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateNewTransactionPurposeRequest., must be bigger than or equal to 2.');
        }
     ...
     *
     * @param int $purpose_account_id purpose_account_id
     *
     * @return self
     */
    public function setPurposeAccountId($purpose_account_id)
    {
        if (is_null($purpose_account_id)) {
            array_push($this->openAPINullablesSetToNull, 'purpose_account_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('purpose_account_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
