    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Resource., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($name) < 2)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Resource., must be bigger than or equal to 2.');
        }
    ...
    public function setNamePlural($name_plural)
    {
        ...
        if ((mb_strlen($name_plural) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name_plural when calling Resource., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($name_plural) < 2)) {
            throw new \InvalidArgumentException('invalid length for $name_plural when calling Resource., must be bigger than or equal to 2.');
        }
