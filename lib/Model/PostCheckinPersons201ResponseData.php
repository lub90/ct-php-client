<?php
/**
 * PostCheckinPersons201ResponseData
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * PostCheckinPersons201ResponseData Class Doc Comment
 *
 * @category Class
 ...
 */
class PostCheckinPersons201ResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_checkin_persons_201_response_data';
    ...
    protected static $openAPITypes = [
        ...
        'date_of_resign' => 'string',
        'department_ids' => 'int[]',
        'edit_security_level_for_person' => 'int',
        'email' => 'string',
        'emails' => '\ChurchTools\Model\PostCheckinPersons201ResponseDataEmailsInner[]',
        ...
        'privacy_policy_agreement' => '\ChurchTools\Model\PutCheckinPersons200ResponseDataPrivacyPolicyAgreement',
        'privacy_policy_agreement_date' => '\DateTime',
        'privacy_policy_agreement_type_id' => 'int',
        'privacy_policy_agreement_who_id' => 'int',
        'referred_by' => 'string',
        'referred_to' => 'string',
    ...
    protected static $openAPIFormats = [
        ...
        'privacy_policy_agreement_type_id' => null,
        'privacy_policy_agreement_who_id' => null,
        'referred_by' => null,
        'referred_to' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'phone_private' => true,
        'phone_work' => true,
        'place_of_baptism' => true,
        'privacy_policy_agreement' => false,
        'privacy_policy_agreement_date' => true,
        'privacy_policy_agreement_type_id' => true,
        'privacy_policy_agreement_who_id' => true,
        'referred_by' => true,
        'referred_to' => true,
    ...
    protected static $attributeMap = [
        ...
        'privacy_policy_agreement_date' => 'privacyPolicyAgreementDate',
        'privacy_policy_agreement_type_id' => 'privacyPolicyAgreementTypeId',
        'privacy_policy_agreement_who_id' => 'privacyPolicyAgreementWhoId',
    ...
    protected static $setters = [
        'acceptedsecurity' => 'setAcceptedsecurity',
        ...
        'privacy_policy_agreement_date' => 'setPrivacyPolicyAgreementDate',
        'privacy_policy_agreement_type_id' => 'setPrivacyPolicyAgreementTypeId',
        'privacy_policy_agreement_who_id' => 'setPrivacyPolicyAgreementWhoId',
    ...
    protected static $getters = [
        'acceptedsecurity' => 'getAcceptedsecurity',
        ...
        'privacy_policy_agreement_date' => 'getPrivacyPolicyAgreementDate',
        'privacy_policy_agreement_type_id' => 'getPrivacyPolicyAgreementTypeId',
        'privacy_policy_agreement_who_id' => 'getPrivacyPolicyAgreementWhoId',
    ...
    {
        $this->setIfExists('acceptedsecurity', $data ?? [], null);
        ...
        $this->setIfExists('privacy_policy_agreement_date', $data ?? [], null);
        $this->setIfExists('privacy_policy_agreement_type_id', $data ?? [], null);
        $this->setIfExists('privacy_policy_agreement_who_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['edit_security_level_for_person'] === null) {
            $invalidProperties[] = "'edit_security_level_for_person' can't be null";
        }
        ...
        if ($this->container['security_level_for_person'] === null) {
            $invalidProperties[] = "'security_level_for_person' can't be null";
        }
    ...
    /**
     * Gets acceptedsecurity
     *
     * @return \DateTime|null
     */
    public function getAcceptedsecurity()
    {
        return $this->container['acceptedsecurity'];
    }

    /**
     * Sets acceptedsecurity
     *
     * @param \DateTime|null $acceptedsecurity A simple date in ISO format, e.g. '2022-10-19'
     *
     * @return self
     */
    public function setAcceptedsecurity($acceptedsecurity)
    {
        if (is_null($acceptedsecurity)) {
            array_push($this->openAPINullablesSetToNull, 'acceptedsecurity');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('acceptedsecurity', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['acceptedsecurity'] = $acceptedsecurity;
    ...
    public function setAddressAddition($address_addition)
    {
        if (is_null($address_addition)) {
            array_push($this->openAPINullablesSetToNull, 'address_addition');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('address_addition', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets age
     *
     * @param int|null $age This computed field contains the age of this person if the date of birth is visible. If this person already dead, the age is calculated until the date of death.
     *
     * @return self
     */
    ...
    public function setBaptisedBy($baptised_by)
    {
        if (is_null($baptised_by)) {
            array_push($this->openAPINullablesSetToNull, 'baptised_by');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('baptised_by', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets birthday
     *
     * @param \DateTime|null $birthday A simple date in ISO format, e.g. '2022-10-19'
     *
     * @return self
     */
    ...
    public function setCmsUserId($cms_user_id)
    {
        if (is_null($cms_user_id)) {
            array_push($this->openAPINullablesSetToNull, 'cms_user_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('cms_user_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param \DateTime|null $date_of_baptism A simple date in ISO format, e.g. '2022-10-19'
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $date_of_belonging A simple date in ISO format, e.g. '2022-10-19'
     *
     * @return self
     */
     ...
     * Sets date_of_death
     *
     * @param \DateTime|null $date_of_death A simple date in ISO format, e.g. '2022-10-19'
     *
     * @return self
     */
     ...
     * Sets date_of_entry
     *
     * @param string|null $date_of_entry A simple timestamp in ISO format, e.g. '2022-10-19 12:00:00'
     *
     * @return self
     */
     ...
     * Sets date_of_resign
     *
     * @param string|null $date_of_resign A simple timestamp in ISO format, e.g. '2022-10-19 12:00:00'
     *
     * @return self
     */
     ...
     *
     * @param int $edit_security_level_for_person Edit security level of the current person. The user can edit fields upto this level.
     *
     * @return self
     */
     ...
     * Sets email
     *
     * @param string|null $email Primary email address of the person.
     *
     * @return self
     */
     ...
     * Gets emails
     *
     * @return \ChurchTools\Model\PostCheckinPersons201ResponseDataEmailsInner[]|null
     */
     ...
     * Sets emails
     *
     * @param \ChurchTools\Model\PostCheckinPersons201ResponseDataEmailsInner[]|null $emails emails
     *
     * @return self
     */
    ...
    public function setFamilyStatusId($family_status_id)
    {
        if (is_null($family_status_id)) {
            array_push($this->openAPINullablesSetToNull, 'family_status_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('family_status_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets first_contact
     *
     * @param string|null $first_contact A simple timestamp in ISO format, e.g. '2022-10-19 12:00:00'
     *
     * @return self
     */
    ...
    public function setGrowPathId($grow_path_id)
    {
        if (is_null($grow_path_id)) {
            array_push($this->openAPINullablesSetToNull, 'grow_path_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('grow_path_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets is_dead
     *
     * @param bool|null $is_dead This computed field is true iff a date of death is set for this person.
     *
     * @return self
     */
    ...
    public function setLastEditedDate($last_edited_date)
    {
        if (is_null($last_edited_date)) {
            array_push($this->openAPINullablesSetToNull, 'last_edited_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('last_edited_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets last_login
     *
     * @param \DateTime|null $last_login A timestamp in Zulu time format, e.g. '2022-10-19T12:00:00Z'
     *
     * @return self
     */
    ...
    public function setPhonePrivate($phone_private)
    {
        if (is_null($phone_private)) {
            array_push($this->openAPINullablesSetToNull, 'phone_private');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('phone_private', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setPhoneWork($phone_work)
    {
        if (is_null($phone_work)) {
            array_push($this->openAPINullablesSetToNull, 'phone_work');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('phone_work', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setPlaceOfBaptism($place_of_baptism)
    {
        if (is_null($place_of_baptism)) {
            array_push($this->openAPINullablesSetToNull, 'place_of_baptism');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('place_of_baptism', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @return \ChurchTools\Model\PutCheckinPersons200ResponseDataPrivacyPolicyAgreement|null
     * @deprecated
     */
     ...
     *
     * @param \ChurchTools\Model\PutCheckinPersons200ResponseDataPrivacyPolicyAgreement|null $privacy_policy_agreement privacy_policy_agreement
     *
     * @return self
     * @deprecated
     */
    ...
    /**
     * Gets privacy_policy_agreement_date
     *
     * @return \DateTime|null
     */
    public function getPrivacyPolicyAgreementDate()
    {
        return $this->container['privacy_policy_agreement_date'];
    }

    /**
     * Sets privacy_policy_agreement_date
     *
     * @param \DateTime|null $privacy_policy_agreement_date A simple date in ISO format, e.g. '2022-10-19'
     *
     * @return self
     */
    public function setPrivacyPolicyAgreementDate($privacy_policy_agreement_date)
    {
        if (is_null($privacy_policy_agreement_date)) {
            array_push($this->openAPINullablesSetToNull, 'privacy_policy_agreement_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('privacy_policy_agreement_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['privacy_policy_agreement_date'] = $privacy_policy_agreement_date;

        return $this;
    }

    /**
     * Gets privacy_policy_agreement_type_id
     *
     * @return int|null
     */
    public function getPrivacyPolicyAgreementTypeId()
    {
        return $this->container['privacy_policy_agreement_type_id'];
    }

    /**
     * Sets privacy_policy_agreement_type_id
     *
     * @param int|null $privacy_policy_agreement_type_id privacy_policy_agreement_type_id
     *
     * @return self
     */
    public function setPrivacyPolicyAgreementTypeId($privacy_policy_agreement_type_id)
    {
        if (is_null($privacy_policy_agreement_type_id)) {
            array_push($this->openAPINullablesSetToNull, 'privacy_policy_agreement_type_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('privacy_policy_agreement_type_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['privacy_policy_agreement_type_id'] = $privacy_policy_agreement_type_id;

        return $this;
    }

    /**
     * Gets privacy_policy_agreement_who_id
     *
     * @return int|null
     */
    public function getPrivacyPolicyAgreementWhoId()
    {
        return $this->container['privacy_policy_agreement_who_id'];
    }

    /**
     * Sets privacy_policy_agreement_who_id
     *
     * @param int|null $privacy_policy_agreement_who_id privacy_policy_agreement_who_id
     *
     * @return self
     */
    public function setPrivacyPolicyAgreementWhoId($privacy_policy_agreement_who_id)
    {
        if (is_null($privacy_policy_agreement_who_id)) {
            array_push($this->openAPINullablesSetToNull, 'privacy_policy_agreement_who_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('privacy_policy_agreement_who_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['privacy_policy_agreement_who_id'] = $privacy_policy_agreement_who_id;
    ...
    public function setReferredTo($referred_to)
    {
        if (is_null($referred_to)) {
            array_push($this->openAPINullablesSetToNull, 'referred_to');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('referred_to', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param int $security_level_for_person Security level of the current person. The user sees fields upto this level.
     *
     * @return self
     */
    ...
    {
        if (is_null($sex_id)) {
            array_push($this->openAPINullablesSetToNull, 'sex_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('sex_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets wedding_date
     *
     * @param \DateTime|null $wedding_date A simple date in ISO format, e.g. '2022-10-19'
     *
     * @return self
     */
