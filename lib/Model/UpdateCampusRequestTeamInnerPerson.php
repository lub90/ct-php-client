<?php
/**
 * UpdateCampusRequestTeamInnerPerson
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * UpdateCampusRequestTeamInnerPerson Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateCampusRequestTeamInnerPerson implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'update_campus_request_team_inner_person';
    ...
    */
    ...
    public function setDomainIdentifier($domain_identifier)
    {
        ...
        if ((mb_strlen($domain_identifier) < 1)) {
            throw new \InvalidArgumentException('invalid length for $domain_identifier when calling UpdateCampusRequestTeamInnerPerson., must be bigger than or equal to 1.');
        }
