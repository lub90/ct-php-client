    ...
    */
    ...
    public function setLineEnding($line_ending)
    {
        ...
        if ((mb_strlen($line_ending) > 10)) {
            throw new \InvalidArgumentException('invalid length for $line_ending when calling PutDbfieldsFieldIdRequest., must be smaller than or equal to 10.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PutDbfieldsFieldIdRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($name) < 2)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PutDbfieldsFieldIdRequest., must be bigger than or equal to 2.');
        }
    ...
    public function setShorty($shorty)
    {
        ...
        if ((mb_strlen($shorty) > 50)) {
            throw new \InvalidArgumentException('invalid length for $shorty when calling PutDbfieldsFieldIdRequest., must be smaller than or equal to 50.');
        }
