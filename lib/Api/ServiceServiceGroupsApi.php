...
class ServiceServiceGroupsApi
{
     ...
     * @throws \ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \ChurchTools\Model\GetService200Response
     */
     ...
     * @throws \ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ChurchTools\Model\GetService200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getServiceWithHttpInfo($service_id, string $contentType = self::contentTypes['getService'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\ChurchTools\Model\GetService200Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\ChurchTools\Model\GetService200Response';
        $request = $this->getServiceRequest($service_id, $contentType);
     ...
     * @throws \ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \ChurchTools\Model\GetServiceGroup200Response
     */
     ...
     * @throws \ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ChurchTools\Model\GetServiceGroup200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getServiceGroupWithHttpInfo($service_group_id, string $contentType = self::contentTypes['getServiceGroup'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\ChurchTools\Model\GetServiceGroup200Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\ChurchTools\Model\GetServiceGroup200Response';
        $request = $this->getServiceGroupRequest($service_group_id, $contentType);
     ...
     * @throws \ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \ChurchTools\Model\GetServiceGroups200Response
     */
     ...
     * @throws \ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ChurchTools\Model\GetServiceGroups200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getServiceGroupsWithHttpInfo(string $contentType = self::contentTypes['getServiceGroups'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\ChurchTools\Model\GetServiceGroups200Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\ChurchTools\Model\GetServiceGroups200Response';
        $request = $this->getServiceGroupsRequest($contentType);
     ...
     * @throws \ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \ChurchTools\Model\GetServices200Response
     */
     ...
     * @throws \ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ChurchTools\Model\GetServices200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getServicesWithHttpInfo(string $contentType = self::contentTypes['getServices'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\ChurchTools\Model\GetServices200Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\ChurchTools\Model\GetServices200Response';
        $request = $this->getServicesRequest($contentType);
