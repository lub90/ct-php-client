...
class ProfileApi
{
     ...
     * @return \ChurchTools\Model\GetApiProfiles200Response
     */
     ...
     * @throws \ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ChurchTools\Model\GetApiProfiles200Response, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\ChurchTools\Model\GetApiProfiles200Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\ChurchTools\Model\GetApiProfiles200Response';
        $request = $this->getApiProfilesRequest($contentType);
     ...
     * @throws \ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \ChurchTools\Model\GetProfilesChurch200Response
     */
     ...
     * @throws \ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ChurchTools\Model\GetProfilesChurch200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProfilesChurchWithHttpInfo(string $contentType = self::contentTypes['getProfilesChurch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\ChurchTools\Model\GetProfilesChurch200Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\ChurchTools\Model\GetProfilesChurch200Response';
        $request = $this->getProfilesChurchRequest($contentType);
     ...
     * 
     *
     * @param  \ChurchTools\Model\UpdateCampusRequest|null $update_campus_request update_campus_request (optional)
     ...
     * @throws \ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \ChurchTools\Model\GetCampus200Response
     */
     ...
     * 
     *
     * @param  \ChurchTools\Model\UpdateCampusRequest|null $update_campus_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['putProfilesChurch'] to see the possible values for this operation
     *
     * @throws \ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ChurchTools\Model\GetCampus200Response, HTTP status code, HTTP response headers (array of strings)
     */
