...
class AbsenceApi
{
     ...
     * @param  string|null $order_direction order_direction (optional)
     ...
     * @throws \ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \ChurchTools\Model\GetGroupsAbsences200Response|string
     */
    public function getGroupsAbsences($group_id, $from = null, $to = null, $order_direction = null, string $contentType = self::contentTypes['getGroupsAbsences'][0])
    {
        list($response) = $this->getGroupsAbsencesWithHttpInfo($group_id, $from, $to, $order_direction, $contentType);
        return $response;
    }
     ...
     * @param  \DateTime|null $from Return entities starting from this date. (optional)
     * @param  \DateTime|null $to Return entities up to (but not including) this date. (optional)
     * @param  string|null $order_direction (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getGroupsAbsences'] to see the possible values for this operation
     *
     * @throws \ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ChurchTools\Model\GetGroupsAbsences200Response|string, HTTP status code, HTTP response headers (array of strings)
     */
    public function getGroupsAbsencesWithHttpInfo($group_id, $from = null, $to = null, $order_direction = null, string $contentType = self::contentTypes['getGroupsAbsences'][0])
    {
        $request = $this->getGroupsAbsencesRequest($group_id, $from, $to, $order_direction, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\ChurchTools\Model\GetGroupsAbsences200Response',
                        $request,
                        $response,
                    );
                case 401:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getGroupsAbsencesAsync($group_id, $from = null, $to = null, $order_direction = null, string $contentType = self::contentTypes['getGroupsAbsences'][0])
    {
        return $this->getGroupsAbsencesAsyncWithHttpInfo($group_id, $from, $to, $order_direction, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getGroupsAbsencesAsyncWithHttpInfo($group_id, $from = null, $to = null, $order_direction = null, string $contentType = self::contentTypes['getGroupsAbsences'][0])
    {
        $returnType = '\ChurchTools\Model\GetGroupsAbsences200Response';
        $request = $this->getGroupsAbsencesRequest($group_id, $from, $to, $order_direction, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getGroupsAbsencesRequest($group_id, $from = null, $to = null, $order_direction = null, string $contentType = self::contentTypes['getGroupsAbsences'][0])
    {
     ...
     * @throws \ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \ChurchTools\Model\PostPersonsAbsences201Response
     */
     ...
     * @throws \ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ChurchTools\Model\PostPersonsAbsences201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPersonsAbsenceWithHttpInfo($person_id, $id, string $contentType = self::contentTypes['getPersonsAbsence'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\ChurchTools\Model\PostPersonsAbsences201Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\ChurchTools\Model\PostPersonsAbsences201Response';
        $request = $this->getPersonsAbsenceRequest($person_id, $id, $contentType);
     ...
     * @throws \ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \ChurchTools\Model\GetGroupsAbsences200Response
     */
    public function getPersonsAbsences($person_id, $from = null, $to = null, $order_direction = null, string $contentType = self::contentTypes['getPersonsAbsences'][0])
    {
        list($response) = $this->getPersonsAbsencesWithHttpInfo($person_id, $from, $to, $order_direction, $contentType);
        return $response;
    }
     ...
     * @throws \ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ChurchTools\Model\GetGroupsAbsences200Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPersonsAbsencesWithHttpInfo($person_id, $from = null, $to = null, $order_direction = null, string $contentType = self::contentTypes['getPersonsAbsences'][0])
    {
        $request = $this->getPersonsAbsencesRequest($person_id, $from, $to, $order_direction, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPersonsAbsencesAsync($person_id, $from = null, $to = null, $order_direction = null, string $contentType = self::contentTypes['getPersonsAbsences'][0])
    {
        return $this->getPersonsAbsencesAsyncWithHttpInfo($person_id, $from, $to, $order_direction, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPersonsAbsencesAsyncWithHttpInfo($person_id, $from = null, $to = null, $order_direction = null, string $contentType = self::contentTypes['getPersonsAbsences'][0])
    {
        $returnType = '\ChurchTools\Model\GetGroupsAbsences200Response';
        $request = $this->getPersonsAbsencesRequest($person_id, $from, $to, $order_direction, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPersonsAbsencesRequest($person_id, $from = null, $to = null, $order_direction = null, string $contentType = self::contentTypes['getPersonsAbsences'][0])
    {
     ...
     *
     * @param  int $person_id ID of person (required)
     * @param  \ChurchTools\Model\PostPersonsAbsencesRequest|null $post_persons_absences_request Absences can be all-day or with a specific time. Either &#x60;startDate&#x60;, &#x60;endDate&#x60;  or &#x60;startTime&#x60;, &#x60;endTime&#x60; MUST be present. If &#x60;*Time&#x60; is given, the &#x60;*Date&#x60; value will be ignored. (optional)
    ...
    public function postPersonsAbsencesRequest($person_id, $post_persons_absences_request = null, string $contentType = self::contentTypes['postPersonsAbsences'][0])
    {
        ...
        if (isset($post_persons_absences_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($post_persons_absences_request));
            } else {
     ...
     * @param  int $person_id ID of person (required)
     * @param  int $id ID of Entity (required)
     * @param  \ChurchTools\Model\PutPersonsAbsenceRequest|null $put_persons_absence_request Absences can be all-day or with a specific time. Either &#x60;startDate&#x60;, &#x60;endDate&#x60;  or &#x60;startTime&#x60;, &#x60;endTime&#x60; MUST be present. If &#x60;*Time&#x60; is given, the &#x60;*Date&#x60; value will be ignored. (optional)
    ...
    public function putPersonsAbsenceRequest($person_id, $id, $put_persons_absence_request = null, string $contentType = self::contentTypes['putPersonsAbsence'][0])
    {
        ...
        if (isset($put_persons_absence_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($put_persons_absence_request));
            } else {
