...
class MasterDataApi
{
     ...
     * @throws \ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \ChurchTools\Model\GetAllData200Response|string
     */
     ...
     * @throws \ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ChurchTools\Model\GetAllData200Response|string, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\ChurchTools\Model\GetAllData200Response',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\ChurchTools\Model\GetAllData200Response';
        $request = $this->getAllDataRequest($accounting_period_id, $contentType);
     ...
     * @throws \ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \ChurchTools\Model\GetPRMasterdata201Response|string
     */
    public function getPRMasterdata(string $contentType = self::contentTypes['getPRMasterdata'][0])
    {
        list($response) = $this->getPRMasterdataWithHttpInfo($contentType);
        return $response;
    }
     ...
     * @throws \ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ChurchTools\Model\GetPRMasterdata201Response|string, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPRMasterdataWithHttpInfo(string $contentType = self::contentTypes['getPRMasterdata'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    return $this->handleResponseWithDataType(
                        '\ChurchTools\Model\GetPRMasterdata201Response',
                        $request,
                        $response,
                    );
                case 401:
    ...
    {
        $returnType = '\ChurchTools\Model\GetPRMasterdata201Response';
        $request = $this->getPRMasterdataRequest($contentType);
