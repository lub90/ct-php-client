...
class JobApi
{
     ...
     * @param  int[]|null $domain_ids domain_ids (optional)
     * @param  string|null $created_start_date created_start_date (optional)
     * @param  string|null $created_end_date created_end_date (optional)
     * @param  string|null $modified_start_date modified_start_date (optional)
     * @param  string|null $modified_end_date modified_end_date (optional)
     ...
     * @return \ChurchTools\Model\GetJobs200Response
     */
     ...
     * @param  int[]|null $domain_ids (optional)
     * @param  string|null $created_start_date (optional)
     * @param  string|null $created_end_date (optional)
     * @param  string|null $modified_start_date (optional)
     * @param  string|null $modified_end_date (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getJobs'] to see the possible values for this operation
     *
     * @throws \ChurchTools\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ChurchTools\Model\GetJobs200Response, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\ChurchTools\Model\GetJobs200Response',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\ChurchTools\Model\GetJobs200Response';
        $request = $this->getJobsRequest($status, $identifier, $name, $domain_ids, $created_start_date, $created_end_date, $modified_start_date, $modified_end_date, $contentType);
