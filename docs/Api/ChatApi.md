...
```php
createNewChat($create_new_chat_request): \ChurchTools\Model\GetAllChats200Response
```
...
$apiInstance = new ChurchTools\Api\ChatApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$create_new_chat_request = new \ChurchTools\Model\CreateNewChatRequest(); // \ChurchTools\Model\CreateNewChatRequest | Chat to start
...
| ------------- | ------------- | ------------- | ------------- |
| **create_new_chat_request** | [**\ChurchTools\Model\CreateNewChatRequest**](../Model/CreateNewChatRequest.md)| Chat to start | |

### Return type

[**\ChurchTools\Model\GetAllChats200Response**](../Model/GetAllChats200Response.md)
...
```php
getAllChats(): \ChurchTools\Model\GetAllChats200Response
```
...
```php
updateChat($guid, $update_chat_request): \ChurchTools\Model\GetAllChats200Response
```
...
$guid = 681F54E3-2EB7-40A4-84F0-EFF8E8F05727; // string | GUID for Entity
$update_chat_request = new \ChurchTools\Model\UpdateChatRequest(); // \ChurchTools\Model\UpdateChatRequest | data to update
...
| ------------- | ------------- | ------------- | ------------- |
| **guid** | **string**| GUID for Entity | |
| **update_chat_request** | [**\ChurchTools\Model\UpdateChatRequest**](../Model/UpdateChatRequest.md)| data to update | |
