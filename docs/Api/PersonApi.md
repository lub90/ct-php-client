...
| [**deletePersonLoginToken()**](PersonApi.md#deletePersonLoginToken) | **DELETE** /persons/{personId}/logintoken | TODO |
| [**deletePersonPrivacyPolicy()**](PersonApi.md#deletePersonPrivacyPolicy) | **DELETE** /persons/{personId}/privacypolicy |  |
...
| [**deletePersonsPersonIdDevicesDeviceId()**](PersonApi.md#deletePersonsPersonIdDevicesDeviceId) | **DELETE** /persons/{personId}/devices/{deviceId} | Delete device for person |
...
| [**getDeviceForPerson()**](PersonApi.md#getDeviceForPerson) | **GET** /persons/{personId}/devices/{deviceId} | Get specified device |
...
| [**getPersonLoginstring()**](PersonApi.md#getPersonLoginstring) | **GET** /persons/{personId}/loginstring | Get login string for a person |
...
| [**getPersonPrivacyPolicy()**](PersonApi.md#getPersonPrivacyPolicy) | **GET** /persons/{personId}/privacypolicy |  |
...
| [**getPersonsPersonIdDevices()**](PersonApi.md#getPersonsPersonIdDevices) | **GET** /persons/{personId}/devices | Get all registered devices for person |
| [**getPersonsPersonIdPosts()**](PersonApi.md#getPersonsPersonIdPosts) | **GET** /persons/{personId}/posts | Returns the posts authored by a person |
...
| [**getPersonsRelationships()**](PersonApi.md#getPersonsRelationships) | **GET** /persons/relationships | Get all relationships for all persons |
...
| [**putPersonsPersonIdDevicesDeviceId()**](PersonApi.md#putPersonsPersonIdDevicesDeviceId) | **PUT** /persons/{personId}/devices/{deviceId} | Create or update new device for person |
...
```php
createPerson($create_person_request, $force, $without_privacy_policy_agreement): \ChurchTools\Model\PostCheckinPersons201Response
```
...
$apiInstance = new ChurchTools\Api\PersonApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$create_person_request = new \ChurchTools\Model\CreatePersonRequest(); // \ChurchTools\Model\CreatePersonRequest | Include those fields you want to add and are allowed to write.
...
| ------------- | ------------- | ------------- | ------------- |
| **create_person_request** | [**\ChurchTools\Model\CreatePersonRequest**](../Model/CreatePersonRequest.md)| Include those fields you want to add and are allowed to write. | |
...
$comment = Holiday; // string | Comment
...
try {
    ...
    echo 'Exception when calling PersonApi->deletePersonLoginToken: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling PersonApi->deletePersonPrivacyPolicy: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
deletePersonsPersonIdDevicesDeviceId($person_id, $device_id)
```
...
try {
    $apiInstance->deletePersonsPersonIdDevicesDeviceId($person_id, $device_id);
} catch (Exception $e) {
    echo 'Exception when calling PersonApi->deletePersonsPersonIdDevicesDeviceId: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getAllPersonSettings($person_id): \ChurchTools\Model\GetAllPersonSettings200Response
```
...
[**\ChurchTools\Model\GetAllPersonSettings200Response**](../Model/GetAllPersonSettings200Response.md)
...
```php
getAllPersons($ids, $status_ids, $campus_ids, $birthday_before, $birthday_after, $is_archived, $is_account_locked, $page, $limit, $include): \ChurchTools\Model\GetAllPersons200Response
```
...
$is_account_locked = True; // bool | Show only persons with locked/not locked account
...
try {
    $result = $apiInstance->getAllPersons($ids, $status_ids, $campus_ids, $birthday_before, $birthday_after, $is_archived, $is_account_locked, $page, $limit, $include);
    print_r($result);
} catch (Exception $e) {
...
| **is_account_locked** | **bool**| Show only persons with locked/not locked account | [optional] |
...
[**\ChurchTools\Model\GetAllPersons200Response**](../Model/GetAllPersons200Response.md)
...
```php
getDeviceForPerson($person_id, $device_id): \ChurchTools\Model\GetDeviceForPerson200Response
```
...
[**\ChurchTools\Model\GetDeviceForPerson200Response**](../Model/GetDeviceForPerson200Response.md)
...
```php
getOpenServiceRequestsForPerson($person_id, $only_future): \ChurchTools\Model\GetOpenServiceRequestsForPerson200Response
```
...
$person_id = 42; // int | ID of person
$only_future = true; // bool | If set to true, only service requests still future are returned (no matter which state). Otherwise (default), open requests from past and future are returned.

try {
    $result = $apiInstance->getOpenServiceRequestsForPerson($person_id, $only_future);
    print_r($result);
} catch (Exception $e) {
...
| ------------- | ------------- | ------------- | ------------- |
| **person_id** | **int**| ID of person | |
| **only_future** | **bool**| If set to true, only service requests still future are returned (no matter which state). Otherwise (default), open requests from past and future are returned. | [optional] [default to false] |

### Return type

[**\ChurchTools\Model\GetOpenServiceRequestsForPerson200Response**](../Model/GetOpenServiceRequestsForPerson200Response.md)
...
```php
getPersonById($person_id): \ChurchTools\Model\PostCheckinPersons201Response
```
...
```php
getPersonLoginstring($person_id): \ChurchTools\Model\GetPersonLoginstring200Response
```
...
try {
    $result = $apiInstance->getPersonLoginstring($person_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PersonApi->getPersonLoginstring: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ChurchTools\Model\GetPersonLoginstring200Response**](../Model/GetPersonLoginstring200Response.md)
...
```php
getPersonModuleSettings($person_id, $module): \ChurchTools\Model\GetAllPersonSettings200Response
```
...
```php
getPersonPrivacyPolicy($person_id): \ChurchTools\Model\GetPersonPrivacyPolicy200Response
```
...
try {
    $result = $apiInstance->getPersonPrivacyPolicy($person_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PersonApi->getPersonPrivacyPolicy: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ChurchTools\Model\GetPersonPrivacyPolicy200Response**](../Model/GetPersonPrivacyPolicy200Response.md)
...
```php
getPersonProperties($get_person_properties_request): \ChurchTools\Model\GetPersonProperties200Response
```
...
$get_person_properties_request = new \ChurchTools\Model\GetPersonPropertiesRequest(); // \ChurchTools\Model\GetPersonPropertiesRequest | List all person IDs for which you want the property information. If empty, all person IDs are used
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **get_person_properties_request** | [**\ChurchTools\Model\GetPersonPropertiesRequest**](../Model/GetPersonPropertiesRequest.md)| List all person IDs for which you want the property information. If empty, all person IDs are used | [optional] |

### Return type

[**\ChurchTools\Model\GetPersonProperties200Response**](../Model/GetPersonProperties200Response.md)
...
```php
getPersonRelationships($person_id): \ChurchTools\Model\GetPersonRelationships200Response
```
...
[**\ChurchTools\Model\GetPersonRelationships200Response**](../Model/GetPersonRelationships200Response.md)
...
```php
getPersonSetting($person_id, $attribute, $module): \ChurchTools\Model\GetPersonSetting200Response
```
...
[**\ChurchTools\Model\GetPersonSetting200Response**](../Model/GetPersonSetting200Response.md)
...
```php
getPersonsBirthdays($start_date, $end_date, $direction, $page, $limit, $campus_ids, $group_ids, $my_groups): \ChurchTools\Model\GetPersonsBirthdays200Response
```
...
$start_date = 2000-01-01; // \DateTime | Birthdays from that date on, defaults to yesterday
$end_date = 2000-12-31; // \DateTime | Birthdays up to that date, defaults to 30 days from now
...
try {
    $result = $apiInstance->getPersonsBirthdays($start_date, $end_date, $direction, $page, $limit, $campus_ids, $group_ids, $my_groups);
    print_r($result);
} catch (Exception $e) {
...
| **end_date** | **\DateTime**| Birthdays up to that date, defaults to 30 days from now | [optional] |
...
[**\ChurchTools\Model\GetPersonsBirthdays200Response**](../Model/GetPersonsBirthdays200Response.md)
...
```php
getPersonsDuplicates($reset_cache): \ChurchTools\Model\GetPersonsDuplicates200Response
```
...
[**\ChurchTools\Model\GetPersonsDuplicates200Response**](../Model/GetPersonsDuplicates200Response.md)
...
```php
getPersonsIdLogintoken($person_id): \ChurchTools\Model\GetPersonsIdLogintoken200Response
```
...
[**\ChurchTools\Model\GetPersonsIdLogintoken200Response**](../Model/GetPersonsIdLogintoken200Response.md)
...
```php
getPersonsPersonIdDevices($person_id): \ChurchTools\Model\GetPersonsPersonIdDevices200Response
```
...
try {
    $result = $apiInstance->getPersonsPersonIdDevices($person_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PersonApi->getPersonsPersonIdDevices: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ChurchTools\Model\GetPersonsPersonIdDevices200Response**](../Model/GetPersonsPersonIdDevices200Response.md)
...
```php
getPersonsPersonIdPosts($person_id, $filter, $limit, $before, $last_post_indentifier, $after): \ChurchTools\Model\GetPersonsPersonIdPosts200Response
```
...
$person_id = 'person_id_example'; // string
$filter = array('filter_example'); // string[] | Can only be used if the endpoint is called with the personId of the currently logged in user. If a different personId is used in combination with filter[] the result will be empty.
$limit = 10; // int | Number of results per page.
...
try {
    $result = $apiInstance->getPersonsPersonIdPosts($person_id, $filter, $limit, $before, $last_post_indentifier, $after);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PersonApi->getPersonsPersonIdPosts: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **person_id** | **string**|  | |
| **filter** | [**string[]**](../Model/string.md)| Can only be used if the endpoint is called with the personId of the currently logged in user. If a different personId is used in combination with filter[] the result will be empty. | [optional] |
| **limit** | **int**| Number of results per page. | [optional] [default to 10] |
...
[**\ChurchTools\Model\GetPersonsPersonIdPosts200Response**](../Model/GetPersonsPersonIdPosts200Response.md)
...
```php
getPersonsRelationships(): object
```
...
try {
    $result = $apiInstance->getPersonsRelationships();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PersonApi->getPersonsRelationships: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getServiceRequestById($person_id, $request_id): \ChurchTools\Model\GetServiceRequestById200Response
```
...
[**\ChurchTools\Model\GetServiceRequestById200Response**](../Model/GetServiceRequestById200Response.md)
...
```php
patchPerson($person_id, $patch_person_request): \ChurchTools\Model\PostCheckinPersons201Response
```
...
$person_id = 42; // int | ID of person
$patch_person_request = new \ChurchTools\Model\PatchPersonRequest(); // \ChurchTools\Model\PatchPersonRequest | Include those fields you want to update and are allowed to write.
...
| ------------- | ------------- | ------------- | ------------- |
| **person_id** | **int**| ID of person | |
| **patch_person_request** | [**\ChurchTools\Model\PatchPersonRequest**](../Model/PatchPersonRequest.md)| Include those fields you want to update and are allowed to write. | |
...
```php
patchPersonsPersonidMergeDuplicateid($duplicate_id, $person_id, $patch_persons_personid_merge_duplicateid_request)
```
...
$duplicate_id = 100; // string | Id of the doublette person
$person_id = 'person_id_example'; // string | id of the original person
$patch_persons_personid_merge_duplicateid_request = {}; // \ChurchTools\Model\PatchPersonsPersonidMergeDuplicateidRequest | * the fields to be changed in the original person * see also `Patch: updatePerson`

try {
    $apiInstance->patchPersonsPersonidMergeDuplicateid($duplicate_id, $person_id, $patch_persons_personid_merge_duplicateid_request);
} catch (Exception $e) {
...
| **duplicate_id** | **string**| Id of the doublette person | |
| **person_id** | **string**| id of the original person | |
| **patch_persons_personid_merge_duplicateid_request** | [**\ChurchTools\Model\PatchPersonsPersonidMergeDuplicateidRequest**](../Model/PatchPersonsPersonidMergeDuplicateidRequest.md)| * the fields to be changed in the original person * see also &#x60;Patch: updatePerson&#x60; | [optional] |
...
$person_id = 42; // int | ID of person
$post_persons_person_id_archive_request = new \ChurchTools\Model\PostPersonsPersonIdArchiveRequest(); // \ChurchTools\Model\PostPersonsPersonIdArchiveRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **person_id** | **int**| ID of person | |
| **post_persons_person_id_archive_request** | [**\ChurchTools\Model\PostPersonsPersonIdArchiveRequest**](../Model/PostPersonsPersonIdArchiveRequest.md)|  | [optional] |
...
```php
putPersonsPersonIdDevicesDeviceId($person_id, $device_id, $put_persons_person_id_devices_device_id_request): \ChurchTools\Model\PutPersonsPersonIdDevicesDeviceId200Response
```
...
$person_id = 42; // int | ID of person
$device_id = 'device_id_example'; // string
$put_persons_person_id_devices_device_id_request = new \ChurchTools\Model\PutPersonsPersonIdDevicesDeviceIdRequest(); // \ChurchTools\Model\PutPersonsPersonIdDevicesDeviceIdRequest | Device information.

try {
    $result = $apiInstance->putPersonsPersonIdDevicesDeviceId($person_id, $device_id, $put_persons_person_id_devices_device_id_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PersonApi->putPersonsPersonIdDevicesDeviceId: ', $e->getMessage(), PHP_EOL;
}
```
...
| **person_id** | **int**| ID of person | |
| **device_id** | **string**|  | |
| **put_persons_person_id_devices_device_id_request** | [**\ChurchTools\Model\PutPersonsPersonIdDevicesDeviceIdRequest**](../Model/PutPersonsPersonIdDevicesDeviceIdRequest.md)| Device information. | [optional] |

### Return type

[**\ChurchTools\Model\PutPersonsPersonIdDevicesDeviceId200Response**](../Model/PutPersonsPersonIdDevicesDeviceId200Response.md)
...
```php
undoServiceRequestById($person_id, $request_id): \ChurchTools\Model\GetServiceRequestById200Response
```
...
```php
updatePersonSetting($person_id, $attribute, $module, $update_person_setting_request): \ChurchTools\Model\GetPersonSetting200Response
```
...
$attribute = 'attribute_example'; // string | Attribute name of setting
$module = 'module_example'; // string | Module name like `churchdb` or `churchservice`
$update_person_setting_request = new \ChurchTools\Model\UpdatePersonSettingRequest(); // \ChurchTools\Model\UpdatePersonSettingRequest

try {
    $result = $apiInstance->updatePersonSetting($person_id, $attribute, $module, $update_person_setting_request);
    print_r($result);
} catch (Exception $e) {
...
| **attribute** | **string**| Attribute name of setting | |
| **module** | **string**| Module name like &#x60;churchdb&#x60; or &#x60;churchservice&#x60; | |
| **update_person_setting_request** | [**\ChurchTools\Model\UpdatePersonSettingRequest**](../Model/UpdatePersonSettingRequest.md)|  | [optional] |
...
```php
updateServiceRequestById($person_id, $request_id, $update_service_request_by_id_request): \ChurchTools\Model\GetServiceRequestById200Response
```
...
$person_id = 42; // int | ID of person
$request_id = 42; // int | ID of a service request
$update_service_request_by_id_request = new \ChurchTools\Model\UpdateServiceRequestByIdRequest(); // \ChurchTools\Model\UpdateServiceRequestByIdRequest | Send the agreed state and optionally a comment.
...
| **person_id** | **int**| ID of person | |
| **request_id** | **int**| ID of a service request | |
| **update_service_request_by_id_request** | [**\ChurchTools\Model\UpdateServiceRequestByIdRequest**](../Model/UpdateServiceRequestByIdRequest.md)| Send the agreed state and optionally a comment. | |
