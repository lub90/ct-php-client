...
$apiInstance = new ChurchTools\Api\AdminApi(
...
```php
getAllLogs($message, $levels, $before, $after, $person_id, $page, $limit): \ChurchTools\Model\GetAllLogs200Response
```
...
[**\ChurchTools\Model\GetAllLogs200Response**](../Model/GetAllLogs200Response.md)
...
```php
getLogById($id): \ChurchTools\Model\GetLogById200Response
```
...
[**\ChurchTools\Model\GetLogById200Response**](../Model/GetLogById200Response.md)
...
```php
getLoginStatistics($order_by, $page, $limit): \ChurchTools\Model\GetLoginStatistics200Response
```
...
[**\ChurchTools\Model\GetLoginStatistics200Response**](../Model/GetLoginStatistics200Response.md)
...
```php
getSecuritylevels(): \ChurchTools\Model\GetSecuritylevels200Response
```
...
[**\ChurchTools\Model\GetSecuritylevels200Response**](../Model/GetSecuritylevels200Response.md)
...
```php
patchSecuritylevelId($id, $forcereorder, $patch_securitylevel_id_request): \ChurchTools\Model\PatchSecuritylevelId200Response
```
...
$patch_securitylevel_id_request = new \ChurchTools\Model\PatchSecuritylevelIdRequest(); // \ChurchTools\Model\PatchSecuritylevelIdRequest | Information to patch the security level
...
| **patch_securitylevel_id_request** | [**\ChurchTools\Model\PatchSecuritylevelIdRequest**](../Model/PatchSecuritylevelIdRequest.md)| Information to patch the security level | [optional] |

### Return type

[**\ChurchTools\Model\PatchSecuritylevelId200Response**](../Model/PatchSecuritylevelId200Response.md)
...
```php
postSecuritylevelId($id, $post_securitylevel_id_request): \ChurchTools\Model\PostSecuritylevelId200Response
```
...
$id = 1; // int | ID of Entity
$post_securitylevel_id_request = {"name":"Name des neuen Security levels"}; // \ChurchTools\Model\PostSecuritylevelIdRequest
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | **int**| ID of Entity | |
| **post_securitylevel_id_request** | [**\ChurchTools\Model\PostSecuritylevelIdRequest**](../Model/PostSecuritylevelIdRequest.md)|  | [optional] |

### Return type

[**\ChurchTools\Model\PostSecuritylevelId200Response**](../Model/PostSecuritylevelId200Response.md)
