# ChurchTools\DepartmentApi

CRUD methods for department field
...
```php
getDepartments(): \ChurchTools\Model\GetDepartments200Response
```
...
$apiInstance = new ChurchTools\Api\DepartmentApi(
...
[**\ChurchTools\Model\GetDepartments200Response**](../Model/GetDepartments200Response.md)
