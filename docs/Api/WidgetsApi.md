# ChurchTools\WidgetsApi

Endpoints for Widgets
...
```php
getStartpage(): \ChurchTools\Model\GetStartpage200Response
```
...
$apiInstance = new ChurchTools\Api\WidgetsApi(
...
[**\ChurchTools\Model\GetStartpage200Response**](../Model/GetStartpage200Response.md)
...
```php
getWidgetBlog(): \ChurchTools\Model\GetWidgetBlog200Response
```
...
[**\ChurchTools\Model\GetWidgetBlog200Response**](../Model/GetWidgetBlog200Response.md)
...
```php
getWidgetRss(): \ChurchTools\Model\GetWidgetRss200Response
```
...
[**\ChurchTools\Model\GetWidgetRss200Response**](../Model/GetWidgetRss200Response.md)
