...
$apiInstance = new ChurchTools\Api\ContactLabelApi(
...
```php
getContactlabel($id): \ChurchTools\Model\GetContactlabel200Response
```
...
[**\ChurchTools\Model\GetContactlabel200Response**](../Model/GetContactlabel200Response.md)
...
```php
getContactlabels(): \ChurchTools\Model\GetContactlabels200Response
```
...
[**\ChurchTools\Model\GetContactlabels200Response**](../Model/GetContactlabels200Response.md)
...
```php
postContactlabels($post_contactlabels_request): \ChurchTools\Model\PostContactlabels201Response
```
...
$post_contactlabels_request = new \ChurchTools\Model\PostContactlabelsRequest(); // \ChurchTools\Model\PostContactlabelsRequest | 
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **post_contactlabels_request** | [**\ChurchTools\Model\PostContactlabelsRequest**](../Model/PostContactlabelsRequest.md)|  | [optional] |

### Return type

[**\ChurchTools\Model\PostContactlabels201Response**](../Model/PostContactlabels201Response.md)
...
```php
putContactlabel($id, $put_contactlabel_request): \ChurchTools\Model\GetContactlabel200Response
```
...
$id = 1; // int | ID of Entity
$put_contactlabel_request = new \ChurchTools\Model\PutContactlabelRequest(); // \ChurchTools\Model\PutContactlabelRequest | 
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | **int**| ID of Entity | |
| **put_contactlabel_request** | [**\ChurchTools\Model\PutContactlabelRequest**](../Model/PutContactlabelRequest.md)|  | [optional] |
