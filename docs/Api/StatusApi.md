...
```php
createNewStatus($create_new_status_request): \ChurchTools\Model\CreateNewStatus201Response
```
...
$apiInstance = new ChurchTools\Api\StatusApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$create_new_status_request = new \ChurchTools\Model\CreateNewStatusRequest(); // \ChurchTools\Model\CreateNewStatusRequest | Status to add
...
| ------------- | ------------- | ------------- | ------------- |
| **create_new_status_request** | [**\ChurchTools\Model\CreateNewStatusRequest**](../Model/CreateNewStatusRequest.md)| Status to add | |

### Return type

[**\ChurchTools\Model\CreateNewStatus201Response**](../Model/CreateNewStatus201Response.md)
...
```php
getAllStatuses(): \ChurchTools\Model\GetAllStatuses200Response
```
...
[**\ChurchTools\Model\GetAllStatuses200Response**](../Model/GetAllStatuses200Response.md)
...
```php
getStatus($id): \ChurchTools\Model\GetStatus200Response
```
...
[**\ChurchTools\Model\GetStatus200Response**](../Model/GetStatus200Response.md)
...
```php
putStatus($id, $put_status_request): \ChurchTools\Model\GetStatus200Response
```
...
$id = 1; // int | ID of Entity
$put_status_request = new \ChurchTools\Model\PutStatusRequest(); // \ChurchTools\Model\PutStatusRequest | New values for status
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | **int**| ID of Entity | |
| **put_status_request** | [**\ChurchTools\Model\PutStatusRequest**](../Model/PutStatusRequest.md)| New values for status | |
