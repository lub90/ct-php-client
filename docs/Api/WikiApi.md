...
| [**postWikiCategory()**](WikiApi.md#postWikiCategory) | **POST** /wiki/categories | Create a new wiki category. |
| [**putWikiCategory()**](WikiApi.md#putWikiCategory) | **PUT** /wiki/categories/{wikiCategoryId} | Update a wiki category |


## `getWikiCategories()`

```php
getWikiCategories(): \ChurchTools\Model\GetWikiCategories200Response
```
...
$apiInstance = new ChurchTools\Api\WikiApi(
...
[**\ChurchTools\Model\GetWikiCategories200Response**](../Model/GetWikiCategories200Response.md)
...
```php
getWikiCategoriesWikiCategoryIdPages($wiki_category_id): \ChurchTools\Model\GetWikiCategoriesWikiCategoryIdPages200Response
```
...
[**\ChurchTools\Model\GetWikiCategoriesWikiCategoryIdPages200Response**](../Model/GetWikiCategoriesWikiCategoryIdPages200Response.md)
...
```php
getWikiCategoriesWikiCategoryIdPagesIdentifier($wiki_category_id, $identifier): \ChurchTools\Model\GetWikiCategoriesWikiCategoryIdPagesIdentifier200Response
```
...
$wiki_category_id = 42; // int | ID of WikiCategory
$identifier = main; // string | Can either be the pages identifier or its title
...
[**\ChurchTools\Model\GetWikiCategoriesWikiCategoryIdPagesIdentifier200Response**](../Model/GetWikiCategoriesWikiCategoryIdPagesIdentifier200Response.md)
...
```php
getWikiCategoriesWikiCategoryIdPagesIdentifierVersions($wiki_category_id, $identifier): \ChurchTools\Model\GetWikiCategoriesWikiCategoryIdPagesIdentifier200Response
```
...
```php
getWikiCategoriesWikiCategoryIdPagesVersionsVersion($wiki_category_id, $version, $identifier): \ChurchTools\Model\GetWikiCategoriesWikiCategoryIdPagesVersionsVersion200Response
```
...
[**\ChurchTools\Model\GetWikiCategoriesWikiCategoryIdPagesVersionsVersion200Response**](../Model/GetWikiCategoriesWikiCategoryIdPagesVersionsVersion200Response.md)
...
```php
getWikiCategoriesWikiCategoryIdSearch($query, $wiki_category_ids): \ChurchTools\Model\GetWikiCategoriesWikiCategoryIdSearch200Response
```
...
[**\ChurchTools\Model\GetWikiCategoriesWikiCategoryIdSearch200Response**](../Model/GetWikiCategoriesWikiCategoryIdSearch200Response.md)
...
```php
postWikiCategory(): \ChurchTools\Model\PostWikiCategory200Response
```
...
try {
    $result = $apiInstance->postWikiCategory();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling WikiApi->postWikiCategory: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ChurchTools\Model\PostWikiCategory200Response**](../Model/PostWikiCategory200Response.md)
...
```php
putWikiCategory($wiki_category_id): \ChurchTools\Model\PostWikiCategory200Response
```
...
try {
    $result = $apiInstance->putWikiCategory($wiki_category_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling WikiApi->putWikiCategory: ', $e->getMessage(), PHP_EOL;
}
```
