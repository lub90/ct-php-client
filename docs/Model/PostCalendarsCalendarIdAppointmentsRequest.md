...
**title** | **string** |  |
**version** | **int** |  |
**bookings** | [**\ChurchTools\Model\PostCalendarsCalendarIdAppointmentsRequestAllOfBookingsInner[]**](PostCalendarsCalendarIdAppointmentsRequestAllOfBookingsInner.md) |  | [optional]
**events** | [**\ChurchTools\Model\PostCalendarsCalendarIdAppointmentsRequestAllOfEventsInner[]**](PostCalendarsCalendarIdAppointmentsRequestAllOfEventsInner.md) |  | [optional]
**meetingrequests** | [**\ChurchTools\Model\PostCalendarsCalendarIdAppointmentsRequestAllOfMeetingrequestsInner[]**](PostCalendarsCalendarIdAppointmentsRequestAllOfMeetingrequestsInner.md) |  | [optional]
