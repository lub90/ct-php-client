# # PublicGroupFormResultFormInner
...
**options** | [**\ChurchTools\Model\PublicGroupFormResultFormInnerOptionsInner[]**](PublicGroupFormResultFormInnerOptionsInner.md) | Provides the set of allowed options for select fields. | [optional]
