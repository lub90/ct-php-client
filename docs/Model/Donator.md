...
**persons** | [**\ChurchTools\Model\PostBookings201ResponseDataInvolvedPersonsDomainObjectsCreatedBy[]**](PostBookings201ResponseDataInvolvedPersonsDomainObjectsCreatedBy.md) | Contains either one element (a single donator) or two elements (donator and their spouse). |
