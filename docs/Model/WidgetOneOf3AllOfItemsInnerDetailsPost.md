# # WidgetOneOf3AllOfItemsInnerDetailsPost
...
**title** | **string** |  |
**visibility** | **string** |  |
**actor** | [**\ChurchTools\Model\ReportObjectPostCommentAllOfDomainObjectPerson**](ReportObjectPostCommentAllOfDomainObjectPerson.md) |  |
**comments** | [**\ChurchTools\Model\WidgetOneOf3AllOfItemsInnerDetailsPostAllOfCommentsInner[]**](WidgetOneOf3AllOfItemsInnerDetailsPostAllOfCommentsInner.md) |  | [optional]
**comments_active** | **bool** |  |
**group** | [**\ChurchTools\Model\WebsiteDataPostsInGroupAllOfDomainDataGroup**](WebsiteDataPostsInGroupAllOfDomainDataGroup.md) |  |
...
**reactions** | [**\ChurchTools\Model\WidgetOneOf3AllOfItemsInnerDetailsPostAllOfReactionsInner[]**](WidgetOneOf3AllOfItemsInnerDetailsPostAllOfReactionsInner.md) |  | [optional]
